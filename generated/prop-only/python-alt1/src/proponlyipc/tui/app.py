"""Main TUI application for PropOnlyIPC."""
...
class PropOnlyIPCApp(App):
    """A Textual app for PropOnlyIPC client interface."""
    
    # Store the MQTT connection and client globally
    mqtt_connection: Optional[Mqtt5Connection] = None
    prop_only_client: Optional[PropOnlyClient] = None
    ...
    def on_mount(self) -> None:
        ...
        from proponlyipc.tui.connection import ConnectionScreen
        from proponlyipc.tui.discovery import DiscoveryScreen
        from proponlyipc.tui.logs import LogsScreen, install_log_handler
