#!/usr/bin/env python3
"""Launch the PropOnlyIPC TUI."""

import argparse
import logging
from prop_onlyipc.tui.app import PropOnlyIPCApp
...
def main():
    ...
    parser = argparse.ArgumentParser(description="PropOnlyIPC TUI Application")
    parser.add_argument(
        "--cafile",
    ...
    logging.debug("Starting PropOnlyIPC TUI application.")
