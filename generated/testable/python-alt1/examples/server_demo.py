...
if __name__ == '__main__':
    ...
    server = TestableServer(conn, os.environ.get("SERVICE_ID", "py-server-demo:1"), property_access, prefix=os.environ.get("TOPIC_PARAM_PREFIX", "example"))
