"""
MCP plugin for the testable interface, generated by stinger-ipc version 0.10.0a8.
"""
...
class TestableMCPPlugin(StingerMCPPlugin):
    ...
    def get_signals(self) -> list[SignalDefinition]:
        return [
            ...
            SignalDefinition(
                name="json_schema_validated_int",
                description="A signal with a single integer parameter that is validated against a JSON schema.",
            ),
            SignalDefinition(
            ...
            SignalDefinition(
                name="json_schema_validated_string",
                description="A signal with a single string parameter that is validated against a JSON schema.",
            ),
            SignalDefinition(
