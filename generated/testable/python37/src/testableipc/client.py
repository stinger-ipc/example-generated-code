...
JsonSchemaValidatedIntSignalCallbackType = Union[Callable[[int], None], Callable[[Any, int], None]]
...
JsonSchemaValidatedStringSignalCallbackType = Union[Callable[[str], None], Callable[[Any, str], None]]
...
class TestableClient:
    ...
    def __init__(self, connection: IBrokerConnection, instance_info: DiscoveredInstance):
        ...
        self._signal_recv_callbacks_for_json_schema_validated_int: List[JsonSchemaValidatedIntSignalCallbackType] = []
        ...
        self._signal_recv_callbacks_for_json_schema_validated_string: List[JsonSchemaValidatedStringSignalCallbackType] = []
    ...
    def _receive_json_schema_validated_int_signal_message(self, message: Message):
        if message.content_type is None or message.content_type != "application/json":
            self._logger.warning("Received 'jsonSchemaValidatedInt' signal with non-JSON content type")
            return

        model = JsonSchemaValidatedIntSignalPayload.model_validate_json(message.payload)
        kwargs = model.model_dump()

        self._do_callbacks_for(self._signal_recv_callbacks_for_json_schema_validated_int, **kwargs)
    ...
    def _receive_json_schema_validated_string_signal_message(self, message: Message):
        if message.content_type is None or message.content_type != "application/json":
            self._logger.warning("Received 'jsonSchemaValidatedString' signal with non-JSON content type")
            return

        model = JsonSchemaValidatedStringSignalPayload.model_validate_json(message.payload)
        kwargs = model.model_dump()

        self._do_callbacks_for(self._signal_recv_callbacks_for_json_schema_validated_string, **kwargs)
    ...
    def receive_json_schema_validated_int(self, handler: JsonSchemaValidatedIntSignalCallbackType):
        """Used as a decorator for methods which handle particular signals."""
        self._signal_recv_callbacks_for_json_schema_validated_int.append(handler)
        if len(self._signal_recv_callbacks_for_json_schema_validated_int) == 1:
            json_schema_validated_int_topic = "{prefix}/testable/{service_id}/signal/jsonSchemaValidatedInt".format(**self._topic_template_kwargs)  # type: ignore[str-format]
            self._logger.debug("Subscribing to 'jsonSchemaValidatedInt' signal topic %s", json_schema_validated_int_topic)
            self._conn.subscribe(json_schema_validated_int_topic, self._receive_json_schema_validated_int_signal_message)
        return handler
    ...
    def receive_json_schema_validated_string(self, handler: JsonSchemaValidatedStringSignalCallbackType):
        """Used as a decorator for methods which handle particular signals."""
        self._signal_recv_callbacks_for_json_schema_validated_string.append(handler)
        if len(self._signal_recv_callbacks_for_json_schema_validated_string) == 1:
            json_schema_validated_string_topic = "{prefix}/testable/{service_id}/signal/jsonSchemaValidatedString".format(**self._topic_template_kwargs)  # type: ignore[str-format]
            self._logger.debug("Subscribing to 'jsonSchemaValidatedString' signal topic %s", json_schema_validated_string_topic)
            self._conn.subscribe(json_schema_validated_string_topic, self._receive_json_schema_validated_string_signal_message)
        return handler
    ...
    def unmatched_signal_handler(self, handler: UnmatchedSignalCallbackType):
        ...
        if self._all_signals_subscription_id == UNINITIALIZED_SUBSCRIPTION_ID:
            self._all_signals_subscription_id = self._conn.subscribe("{prefix}/testable/{service_id}/signal/+".format(**self._topic_template_kwargs), self._receive_unmatched_signal_message)  # type: ignore[str-format]
        return handler
...
class TestableClientBuilder:
    ...
    def __init__(self):
        ...
        self._signal_recv_callbacks_for_json_schema_validated_int = []  # type: List[JsonSchemaValidatedIntSignalCallbackType]
        ...
        self._signal_recv_callbacks_for_json_schema_validated_string = []  # type: List[JsonSchemaValidatedStringSignalCallbackType]
    ...
    def receive_json_schema_validated_int(self, handler):
        """Used as a decorator for methods which handle particular signals."""
        ...
        self._signal_recv_callbacks_for_json_schema_validated_int.append(wrapper)
        return wrapper
    ...
    def receive_json_schema_validated_string(self, handler):
        """Used as a decorator for methods which handle particular signals."""
        ...
        self._signal_recv_callbacks_for_json_schema_validated_string.append(wrapper)
        return wrapper
    ...
    def build(self, broker: IBrokerConnection, instance_info: DiscoveredInstance, binding: Optional[Any] = None) -> TestableClient:
        ...
        for json_schema_validated_int_cb in self._signal_recv_callbacks_for_json_schema_validated_int:
            if binding:
                client.receive_json_schema_validated_int(json_schema_validated_int_cb.__get__(binding, binding.__class__))
            else:
                client.receive_json_schema_validated_int(json_schema_validated_int_cb)
        ...
        for json_schema_validated_string_cb in self._signal_recv_callbacks_for_json_schema_validated_string:
            if binding:
                client.receive_json_schema_validated_string(json_schema_validated_string_cb.__get__(binding, binding.__class__))
            else:
                client.receive_json_schema_validated_string(json_schema_validated_string_cb)
