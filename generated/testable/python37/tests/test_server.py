    ...
    def test_read_write_struct_property_receive(self, server, mock_connection):
        ...
        prop_data = {
            "value": AllTypes(
                ...
                the_str="example",
                the_enum=Numbers.ONE,
                an_entry_object=Lunch(drink=True, sandwich="example", crackers=1.0, order_number=2020, time_of_lunch=datetime.now(UTC), duration_of_lunch=timedelta(seconds=551)),
                date_and_time=datetime.now(UTC),
    ...
    def test_server_handle_call_three_structs_method(self, server, mock_connection):
        ...
        method_data = {
            ...
            "input3": AllTypes(
                ...
                the_str="foo",
                the_enum=Numbers.ONE,
                an_entry_object=Lunch(drink=True, sandwich="foo", crackers=1.0, order_number=2022, time_of_lunch=datetime.now(UTC), duration_of_lunch=timedelta(seconds=975)),
                date_and_time=datetime.now(UTC),
