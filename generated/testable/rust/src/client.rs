...
impl<C: Mqtt5PubSub + Clone + Send + 'static> TestableClient<C> {
    ...
    pub async fn run_loop(&mut self) -> Result<(), JoinError> {
        ...
        let props = self.properties.clone();
        {
            ...
            let prefix_for_read_write_integer_prop = self.topic_param_prefix.clone();
                ...
                props.read_write_integer.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_write_integer has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_write_integer_prop.clone(),
                            ),
                        ]);
                        ...
                        let resp_topic = strfmt("client/{client_id}/testable/property/read_write_integer/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_write_integer' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_read_write_integer_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!("Received property update response for 'read_write_integer': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            ...
                                            info!("No responder provided for property update request for 'read_write_integer'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_only_integer_prop = self.topic_param_prefix.clone();
                ...
                props.read_only_integer.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_only_integer has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_only_integer_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                        ...
                        let resp_topic = strfmt("client/{client_id}/testable/property/read_only_integer/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_only_integer' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_read_only_integer_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!("Received property update response for 'read_only_integer': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'read_only_integer'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_write_optional_integer_prop = self.topic_param_prefix.clone();
                ...
                props.read_write_optional_integer.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_write_optional_integer has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_write_optional_integer_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt("{prefix}/testable/{service_id}/property/read_write_optional_integer/update", &topic_param_map).unwrap();

                        let resp_topic = strfmt("client/{client_id}/testable/property/read_write_optional_integer/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_write_optional_integer' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_read_write_optional_integer_prop
                                        .publish(msg)
                                        .await;
                                let result = receiver.await;
                                debug!("Received property update response for 'read_write_optional_integer': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'read_write_optional_integer'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_write_two_integers_prop = self.topic_param_prefix.clone();
                ...
                props.read_write_two_integers.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_write_two_integers has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_write_two_integers_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt("{prefix}/testable/{service_id}/property/read_write_two_integers/update", &topic_param_map).unwrap();

                        let resp_topic = strfmt("client/{client_id}/testable/property/read_write_two_integers/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_write_two_integers' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result = publisher_for_read_write_two_integers_prop
                                    .publish(msg)
                                    .await;
                                let result = receiver.await;
                                debug!("Received property update response for 'read_write_two_integers': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'read_write_two_integers'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_only_string_prop = self.topic_param_prefix.clone();
                ...
                props.read_only_string.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_only_string has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_only_string_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_only_string' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_read_only_string_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!("Received property update response for 'read_only_string': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'read_only_string'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_write_string_prop = self.topic_param_prefix.clone();
                ...
                props.read_write_string.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_write_string has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_write_string_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                        ...
                        let resp_topic = strfmt("client/{client_id}/testable/property/read_write_string/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_write_string' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_read_write_string_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!("Received property update response for 'read_write_string': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'read_write_string'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_write_optional_string_prop = self.topic_param_prefix.clone();
                ...
                props.read_write_optional_string.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_write_optional_string has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_write_optional_string_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt("{prefix}/testable/{service_id}/property/read_write_optional_string/update", &topic_param_map).unwrap();

                        let resp_topic = strfmt("client/{client_id}/testable/property/read_write_optional_string/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_write_optional_string' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result = publisher_for_read_write_optional_string_prop
                                    .publish(msg)
                                    .await;
                                let result = receiver.await;
                                debug!("Received property update response for 'read_write_optional_string': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'read_write_optional_string'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_write_two_strings_prop = self.topic_param_prefix.clone();
                ...
                props.read_write_two_strings.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_write_two_strings has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_write_two_strings_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                        ...
                        let resp_topic = strfmt("client/{client_id}/testable/property/read_write_two_strings/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_write_two_strings' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_read_write_two_strings_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!("Received property update response for 'read_write_two_strings': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'read_write_two_strings'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_write_struct_prop = self.topic_param_prefix.clone();
                ...
                props.read_write_struct.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_write_struct has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_write_struct_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                        ...
                        let resp_topic = strfmt("client/{client_id}/testable/property/read_write_struct/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_write_struct' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_read_write_struct_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!("Received property update response for 'read_write_struct': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'read_write_struct'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_write_optional_struct_prop = self.topic_param_prefix.clone();
                ...
                props.read_write_optional_struct.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_write_optional_struct has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_write_optional_struct_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt("{prefix}/testable/{service_id}/property/read_write_optional_struct/update", &topic_param_map).unwrap();

                        let resp_topic = strfmt("client/{client_id}/testable/property/read_write_optional_struct/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_write_optional_struct' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result = publisher_for_read_write_optional_struct_prop
                                    .publish(msg)
                                    .await;
                                let result = receiver.await;
                                debug!("Received property update response for 'read_write_optional_struct': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'read_write_optional_struct'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_write_two_structs_prop = self.topic_param_prefix.clone();
                ...
                props.read_write_two_structs.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_write_two_structs has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_write_two_structs_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                        ...
                        let resp_topic = strfmt("client/{client_id}/testable/property/read_write_two_structs/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_write_two_structs' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_read_write_two_structs_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!("Received property update response for 'read_write_two_structs': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'read_write_two_structs'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_only_enum_prop = self.topic_param_prefix.clone();
                ...
                props.read_only_enum.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_only_enum has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            ("prefix".to_string(), prefix_for_read_only_enum_prop.clone()),
                        ]);
                        let topic: String = strfmt(
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_only_enum' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_read_only_enum_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!(
                                    "Received property update response for 'read_only_enum': {:?}",
                                    result
                                );
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            ...
                                            info!("No responder provided for property update request for 'read_only_enum'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_write_enum_prop = self.topic_param_prefix.clone();
                ...
                props.read_write_enum.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_write_enum has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_write_enum_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_write_enum' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_read_write_enum_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!(
                                    "Received property update response for 'read_write_enum': {:?}",
                                    result
                                );
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            ...
                                            info!("No responder provided for property update request for 'read_write_enum'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_write_optional_enum_prop = self.topic_param_prefix.clone();
                ...
                props.read_write_optional_enum.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_write_optional_enum has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_write_optional_enum_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt("{prefix}/testable/{service_id}/property/read_write_optional_enum/update", &topic_param_map).unwrap();

                        let resp_topic = strfmt("client/{client_id}/testable/property/read_write_optional_enum/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_write_optional_enum' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result = publisher_for_read_write_optional_enum_prop
                                    .publish(msg)
                                    .await;
                                let result = receiver.await;
                                debug!("Received property update response for 'read_write_optional_enum': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'read_write_optional_enum'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_write_two_enums_prop = self.topic_param_prefix.clone();
                ...
                props.read_write_two_enums.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_write_two_enums has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_write_two_enums_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                        ...
                        let resp_topic = strfmt("client/{client_id}/testable/property/read_write_two_enums/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_write_two_enums' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_read_write_two_enums_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!("Received property update response for 'read_write_two_enums': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'read_write_two_enums'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_write_datetime_prop = self.topic_param_prefix.clone();
                ...
                props.read_write_datetime.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_write_datetime has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_write_datetime_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                        ...
                        let resp_topic = strfmt("client/{client_id}/testable/property/read_write_datetime/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_write_datetime' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_read_write_datetime_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!("Received property update response for 'read_write_datetime': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'read_write_datetime'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_write_optional_datetime_prop = self.topic_param_prefix.clone();
                ...
                props.read_write_optional_datetime.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_write_optional_datetime has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_write_optional_datetime_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt("{prefix}/testable/{service_id}/property/read_write_optional_datetime/update", &topic_param_map).unwrap();

                        let resp_topic = strfmt("client/{client_id}/testable/property/read_write_optional_datetime/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_write_optional_datetime' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_read_write_optional_datetime_prop
                                        .publish(msg)
                                        .await;
                                let result = receiver.await;
                                debug!("Received property update response for 'read_write_optional_datetime': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'read_write_optional_datetime'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_write_two_datetimes_prop = self.topic_param_prefix.clone();
                ...
                props.read_write_two_datetimes.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_write_two_datetimes has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_write_two_datetimes_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt("{prefix}/testable/{service_id}/property/read_write_two_datetimes/update", &topic_param_map).unwrap();

                        let resp_topic = strfmt("client/{client_id}/testable/property/read_write_two_datetimes/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_write_two_datetimes' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result = publisher_for_read_write_two_datetimes_prop
                                    .publish(msg)
                                    .await;
                                let result = receiver.await;
                                debug!("Received property update response for 'read_write_two_datetimes': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'read_write_two_datetimes'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_write_duration_prop = self.topic_param_prefix.clone();
                ...
                props.read_write_duration.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_write_duration has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_write_duration_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                        ...
                        let resp_topic = strfmt("client/{client_id}/testable/property/read_write_duration/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_write_duration' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_read_write_duration_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!("Received property update response for 'read_write_duration': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'read_write_duration'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_write_optional_duration_prop = self.topic_param_prefix.clone();
                ...
                props.read_write_optional_duration.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_write_optional_duration has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_write_optional_duration_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt("{prefix}/testable/{service_id}/property/read_write_optional_duration/update", &topic_param_map).unwrap();

                        let resp_topic = strfmt("client/{client_id}/testable/property/read_write_optional_duration/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_write_optional_duration' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_read_write_optional_duration_prop
                                        .publish(msg)
                                        .await;
                                let result = receiver.await;
                                debug!("Received property update response for 'read_write_optional_duration': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'read_write_optional_duration'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_write_two_durations_prop = self.topic_param_prefix.clone();
                ...
                props.read_write_two_durations.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_write_two_durations has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_write_two_durations_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt("{prefix}/testable/{service_id}/property/read_write_two_durations/update", &topic_param_map).unwrap();

                        let resp_topic = strfmt("client/{client_id}/testable/property/read_write_two_durations/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_write_two_durations' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result = publisher_for_read_write_two_durations_prop
                                    .publish(msg)
                                    .await;
                                let result = receiver.await;
                                debug!("Received property update response for 'read_write_two_durations': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'read_write_two_durations'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_write_binary_prop = self.topic_param_prefix.clone();
                ...
                props.read_write_binary.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_write_binary has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_write_binary_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                        ...
                        let resp_topic = strfmt("client/{client_id}/testable/property/read_write_binary/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_write_binary' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_read_write_binary_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!("Received property update response for 'read_write_binary': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'read_write_binary'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_write_optional_binary_prop = self.topic_param_prefix.clone();
                ...
                props.read_write_optional_binary.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_write_optional_binary has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_write_optional_binary_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt("{prefix}/testable/{service_id}/property/read_write_optional_binary/update", &topic_param_map).unwrap();

                        let resp_topic = strfmt("client/{client_id}/testable/property/read_write_optional_binary/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_write_optional_binary' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result = publisher_for_read_write_optional_binary_prop
                                    .publish(msg)
                                    .await;
                                let result = receiver.await;
                                debug!("Received property update response for 'read_write_optional_binary': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'read_write_optional_binary'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_write_two_binaries_prop = self.topic_param_prefix.clone();
                ...
                props.read_write_two_binaries.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_write_two_binaries has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_write_two_binaries_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt("{prefix}/testable/{service_id}/property/read_write_two_binaries/update", &topic_param_map).unwrap();

                        let resp_topic = strfmt("client/{client_id}/testable/property/read_write_two_binaries/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_write_two_binaries' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result = publisher_for_read_write_two_binaries_prop
                                    .publish(msg)
                                    .await;
                                let result = receiver.await;
                                debug!("Received property update response for 'read_write_two_binaries': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'read_write_two_binaries'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_write_list_of_strings_prop = self.topic_param_prefix.clone();
                ...
                props.read_write_list_of_strings.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_write_list_of_strings has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_write_list_of_strings_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt("{prefix}/testable/{service_id}/property/read_write_list_of_strings/update", &topic_param_map).unwrap();

                        let resp_topic = strfmt("client/{client_id}/testable/property/read_write_list_of_strings/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_write_list_of_strings' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result = publisher_for_read_write_list_of_strings_prop
                                    .publish(msg)
                                    .await;
                                let result = receiver.await;
                                debug!("Received property update response for 'read_write_list_of_strings': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'read_write_list_of_strings'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_read_write_lists_prop = self.topic_param_prefix.clone();
                ...
                props.read_write_lists.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property read_write_lists has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_read_write_lists_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'read_write_lists' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_read_write_lists_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!("Received property update response for 'read_write_lists': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'read_write_lists'");
                                        }
                                    }
                                    _ => {
