...
struct TestableSignalChannels {
    ...
    json_schema_validated_int_sender: broadcast::Sender<i32>,
    ...
    json_schema_validated_string_sender: broadcast::Sender<String>,
...
impl<C: Mqtt5PubSub + Clone + Send + 'static> TestableClient<C> {
    ...
    pub async fn new(mut connection: C, discovery_info: DiscoveredService) -> Self {
        ...
        let topic_json_schema_validated_int_signal = strfmt(
            "{prefix}/testable/{service_id}/signal/jsonSchemaValidatedInt",
            &topic_map,
        )
        .unwrap();
        let subscription_id_json_schema_validated_int_signal = connection
            .subscribe(
                topic_json_schema_validated_int_signal,
                QoS::ExactlyOnce,
                message_received_tx.clone(),
            )
            .await;
        let subscription_id_json_schema_validated_int_signal =
            subscription_id_json_schema_validated_int_signal.unwrap_or(u32::MAX);
        debug!(
            "Subscription (id={}) to signal topic for 'jsonSchemaValidatedInt'",
            subscription_id_json_schema_validated_int_signal
        );
        ...
        let topic_json_schema_validated_string_signal = strfmt(
            "{prefix}/testable/{service_id}/signal/jsonSchemaValidatedString",
            &topic_map,
        )
        .unwrap();
        let subscription_id_json_schema_validated_string_signal = connection
            .subscribe(
                topic_json_schema_validated_string_signal,
                QoS::ExactlyOnce,
                message_received_tx.clone(),
            )
            .await;
        let subscription_id_json_schema_validated_string_signal =
            subscription_id_json_schema_validated_string_signal.unwrap_or(u32::MAX);
        debug!(
            "Subscription (id={}) to signal topic for 'jsonSchemaValidatedString'",
            subscription_id_json_schema_validated_string_signal
        );
        topic_map.insert(
            "signal_name".to_string(),
        ...
        let sub_ids = TestableSubscriptionIds {
            ...
            json_schema_validated_int_signal: Some(
                subscription_id_json_schema_validated_int_signal,
            ),
            ...
            json_schema_validated_string_signal: Some(
                subscription_id_json_schema_validated_string_signal,
            ),
        ...
        let signal_channels = TestableSignalChannels {
            ...
            json_schema_validated_int_sender: broadcast::channel(64).0,
            ...
            json_schema_validated_string_sender: broadcast::channel(64).0,
    ...
    /// Get the RX receiver side of the broadcast channel for the 'jsonSchemaValidatedInt' signal.
    /// The signal payload, `JsonSchemaValidatedIntSignalPayload`, will be put onto the channel whenever it is received.
    pub fn get_json_schema_validated_int_receiver(&self) -> broadcast::Receiver<i32> {
        self.signal_channels
            .json_schema_validated_int_sender
            .subscribe()
    }
    ...
    /// Get the RX receiver side of the broadcast channel for the 'jsonSchemaValidatedString' signal.
    /// The signal payload, `JsonSchemaValidatedStringSignalPayload`, will be put onto the channel whenever it is received.
    pub fn get_json_schema_validated_string_receiver(&self) -> broadcast::Receiver<String> {
        self.signal_channels
            .json_schema_validated_string_sender
            .subscribe()
    }
    ...
    async fn start_call_with_nothing(&mut self) -> oneshot::Receiver<MethodReturnCode> {
        ...
        topic_param_map.insert("method_name".to_string(), "callWithNothing".to_string());
        ...
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callWithNothing/response",
            &topic_param_map,
        )
        .unwrap();
    ...
    async fn start_call_one_integer(&mut self, input1: i32) -> oneshot::Receiver<MethodReturnCode> {
        ...
        if let Err(e) = data.validate_schema() {
            error!(
                "Request payload for callOneInteger failed schema validation, not sending: {}",
                e
            );
        ...
        let mut topic_param_map = self.base_topic_params();
        topic_param_map.insert("method_name".to_string(), "callOneInteger".to_string());
        let request_topic: String = strfmt(
        ...
        .unwrap();
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callOneInteger/response",
            &topic_param_map,
        )
        .unwrap();
        let msg = message::request(&request_topic, &data, correlation_id, response_topic).unwrap();
    ...
    async fn start_call_optional_integer(
        ...
        if let Err(e) = data.validate_schema() {
            error!(
                "Request payload for callOptionalInteger failed schema validation, not sending: {}",
                e
            );
            let _ = sender.send(MethodReturnCode::ClientSerializationError(format!(
                "Request payload failed schema validation: {}",
        ...
        let mut topic_param_map = self.base_topic_params();
        topic_param_map.insert("method_name".to_string(), "callOptionalInteger".to_string());
        let request_topic: String = strfmt(
        ...
        .unwrap();
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callOptionalInteger/response",
            &topic_param_map,
        )
        .unwrap();
        let msg = message::request(&request_topic, &data, correlation_id, response_topic).unwrap();
    ...
    async fn start_call_three_integers(
        ...
        if let Err(e) = data.validate_schema() {
            error!(
                "Request payload for callThreeIntegers failed schema validation, not sending: {}",
                e
            );
            let _ = sender.send(MethodReturnCode::ClientSerializationError(format!(
                "Request payload failed schema validation: {}",
        ...
        let mut topic_param_map = self.base_topic_params();
        topic_param_map.insert("method_name".to_string(), "callThreeIntegers".to_string());
        let request_topic: String = strfmt(
        ...
        .unwrap();
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callThreeIntegers/response",
            &topic_param_map,
        )
        .unwrap();
        let msg = message::request(&request_topic, &data, correlation_id, response_topic).unwrap();
    ...
    async fn start_call_one_string(
        ...
        if let Err(e) = data.validate_schema() {
            error!(
                "Request payload for callOneString failed schema validation, not sending: {}",
                e
            );
            let _ = sender.send(MethodReturnCode::ClientSerializationError(format!(
                "Request payload failed schema validation: {}",
        ...
        let mut topic_param_map = self.base_topic_params();
        topic_param_map.insert("method_name".to_string(), "callOneString".to_string());
        let request_topic: String = strfmt(
        ...
        .unwrap();
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callOneString/response",
            &topic_param_map,
        )
        .unwrap();
        let msg = message::request(&request_topic, &data, correlation_id, response_topic).unwrap();
    ...
    async fn start_call_optional_string(
        ...
        if let Err(e) = data.validate_schema() {
            error!(
                "Request payload for callOptionalString failed schema validation, not sending: {}",
                e
            );
            let _ = sender.send(MethodReturnCode::ClientSerializationError(format!(
                "Request payload failed schema validation: {}",
        ...
        let mut topic_param_map = self.base_topic_params();
        topic_param_map.insert("method_name".to_string(), "callOptionalString".to_string());
        let request_topic: String = strfmt(
        ...
        .unwrap();
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callOptionalString/response",
            &topic_param_map,
        )
        .unwrap();
        let msg = message::request(&request_topic, &data, correlation_id, response_topic).unwrap();
    ...
    async fn start_call_three_strings(
        ...
        if let Err(e) = data.validate_schema() {
            error!(
                "Request payload for callThreeStrings failed schema validation, not sending: {}",
                e
            );
            let _ = sender.send(MethodReturnCode::ClientSerializationError(format!(
                "Request payload failed schema validation: {}",
        ...
        let mut topic_param_map = self.base_topic_params();
        topic_param_map.insert("method_name".to_string(), "callThreeStrings".to_string());
        let request_topic: String = strfmt(
        ...
        .unwrap();
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callThreeStrings/response",
            &topic_param_map,
        )
        .unwrap();
        let msg = message::request(&request_topic, &data, correlation_id, response_topic).unwrap();
    ...
    async fn start_call_one_enum(
        ...
        if let Err(e) = data.validate_schema() {
            error!(
                "Request payload for callOneEnum failed schema validation, not sending: {}",
                e
            );
            let _ = sender.send(MethodReturnCode::ClientSerializationError(format!(
                "Request payload failed schema validation: {}",
        ...
        let mut topic_param_map = self.base_topic_params();
        topic_param_map.insert("method_name".to_string(), "callOneEnum".to_string());
        let request_topic: String = strfmt(
        ...
        .unwrap();
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callOneEnum/response",
            &topic_param_map,
        )
        .unwrap();
        let msg = message::request(&request_topic, &data, correlation_id, response_topic).unwrap();
    ...
    async fn start_call_optional_enum(
        ...
        if let Err(e) = data.validate_schema() {
            error!(
                "Request payload for callOptionalEnum failed schema validation, not sending: {}",
                e
            );
            let _ = sender.send(MethodReturnCode::ClientSerializationError(format!(
                "Request payload failed schema validation: {}",
        ...
        let mut topic_param_map = self.base_topic_params();
        topic_param_map.insert("method_name".to_string(), "callOptionalEnum".to_string());
        let request_topic: String = strfmt(
        ...
        .unwrap();
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callOptionalEnum/response",
            &topic_param_map,
        )
        .unwrap();
        let msg = message::request(&request_topic, &data, correlation_id, response_topic).unwrap();
    ...
    async fn start_call_three_enums(
        ...
        if let Err(e) = data.validate_schema() {
            error!(
                "Request payload for callThreeEnums failed schema validation, not sending: {}",
                e
            );
            let _ = sender.send(MethodReturnCode::ClientSerializationError(format!(
                "Request payload failed schema validation: {}",
        ...
        let mut topic_param_map = self.base_topic_params();
        topic_param_map.insert("method_name".to_string(), "callThreeEnums".to_string());
        let request_topic: String = strfmt(
        ...
        .unwrap();
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callThreeEnums/response",
            &topic_param_map,
        )
        .unwrap();
        let msg = message::request(&request_topic, &data, correlation_id, response_topic).unwrap();
    ...
    async fn start_call_one_struct(
        ...
        if let Err(e) = data.validate_schema() {
            error!(
                "Request payload for callOneStruct failed schema validation, not sending: {}",
                e
            );
            let _ = sender.send(MethodReturnCode::ClientSerializationError(format!(
                "Request payload failed schema validation: {}",
        ...
        let mut topic_param_map = self.base_topic_params();
        topic_param_map.insert("method_name".to_string(), "callOneStruct".to_string());
        let request_topic: String = strfmt(
        ...
        .unwrap();
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callOneStruct/response",
            &topic_param_map,
        )
        .unwrap();
        let msg = message::request(&request_topic, &data, correlation_id, response_topic).unwrap();
    ...
    async fn start_call_optional_struct(
        ...
        if let Err(e) = data.validate_schema() {
            error!(
                "Request payload for callOptionalStruct failed schema validation, not sending: {}",
                e
            );
            let _ = sender.send(MethodReturnCode::ClientSerializationError(format!(
                "Request payload failed schema validation: {}",
        ...
        let mut topic_param_map = self.base_topic_params();
        topic_param_map.insert("method_name".to_string(), "callOptionalStruct".to_string());
        let request_topic: String = strfmt(
        ...
        .unwrap();
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callOptionalStruct/response",
            &topic_param_map,
        )
        .unwrap();
        let msg = message::request(&request_topic, &data, correlation_id, response_topic).unwrap();
    ...
    async fn start_call_three_structs(
        ...
        if let Err(e) = data.validate_schema() {
            error!(
                "Request payload for callThreeStructs failed schema validation, not sending: {}",
                e
            );
            let _ = sender.send(MethodReturnCode::ClientSerializationError(format!(
                "Request payload failed schema validation: {}",
        ...
        let mut topic_param_map = self.base_topic_params();
        topic_param_map.insert("method_name".to_string(), "callThreeStructs".to_string());
        let request_topic: String = strfmt(
        ...
        .unwrap();
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callThreeStructs/response",
            &topic_param_map,
        )
        .unwrap();
        let msg = message::request(&request_topic, &data, correlation_id, response_topic).unwrap();
    ...
    async fn start_call_one_date_time(
        ...
        if let Err(e) = data.validate_schema() {
            error!(
                "Request payload for callOneDateTime failed schema validation, not sending: {}",
                e
            );
            let _ = sender.send(MethodReturnCode::ClientSerializationError(format!(
                "Request payload failed schema validation: {}",
        ...
        let mut topic_param_map = self.base_topic_params();
        topic_param_map.insert("method_name".to_string(), "callOneDateTime".to_string());
        let request_topic: String = strfmt(
        ...
        .unwrap();
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callOneDateTime/response",
            &topic_param_map,
        )
        .unwrap();
        let msg = message::request(&request_topic, &data, correlation_id, response_topic).unwrap();
    ...
    async fn start_call_optional_date_time(
        ...
        if let Err(e) = data.validate_schema() {
            error!("Request payload for callOptionalDateTime failed schema validation, not sending: {}", e);
            let _ = sender.send(MethodReturnCode::ClientSerializationError(format!(
                "Request payload failed schema validation: {}",
                e
            )));
        ...
        .unwrap();
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callOptionalDateTime/response",
            &topic_param_map,
        )
        .unwrap();
        let msg = message::request(&request_topic, &data, correlation_id, response_topic).unwrap();
    ...
    async fn start_call_three_date_times(
        ...
        if let Err(e) = data.validate_schema() {
            error!(
                "Request payload for callThreeDateTimes failed schema validation, not sending: {}",
                e
            );
            let _ = sender.send(MethodReturnCode::ClientSerializationError(format!(
                "Request payload failed schema validation: {}",
        ...
        let mut topic_param_map = self.base_topic_params();
        topic_param_map.insert("method_name".to_string(), "callThreeDateTimes".to_string());
        let request_topic: String = strfmt(
        ...
        .unwrap();
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callThreeDateTimes/response",
            &topic_param_map,
        )
        .unwrap();
        let msg = message::request(&request_topic, &data, correlation_id, response_topic).unwrap();
    ...
    async fn start_call_one_duration(
        ...
        if let Err(e) = data.validate_schema() {
            error!(
                "Request payload for callOneDuration failed schema validation, not sending: {}",
                e
            );
            let _ = sender.send(MethodReturnCode::ClientSerializationError(format!(
                "Request payload failed schema validation: {}",
        ...
        let mut topic_param_map = self.base_topic_params();
        topic_param_map.insert("method_name".to_string(), "callOneDuration".to_string());
        let request_topic: String = strfmt(
        ...
        .unwrap();
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callOneDuration/response",
            &topic_param_map,
        )
        .unwrap();
        let msg = message::request(&request_topic, &data, correlation_id, response_topic).unwrap();
    ...
    async fn start_call_optional_duration(
        ...
        if let Err(e) = data.validate_schema() {
            error!("Request payload for callOptionalDuration failed schema validation, not sending: {}", e);
            let _ = sender.send(MethodReturnCode::ClientSerializationError(format!(
                "Request payload failed schema validation: {}",
                e
            )));
        ...
        .unwrap();
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callOptionalDuration/response",
            &topic_param_map,
        )
        .unwrap();
        let msg = message::request(&request_topic, &data, correlation_id, response_topic).unwrap();
    ...
    async fn start_call_three_durations(
        ...
        if let Err(e) = data.validate_schema() {
            error!(
                "Request payload for callThreeDurations failed schema validation, not sending: {}",
                e
            );
            let _ = sender.send(MethodReturnCode::ClientSerializationError(format!(
                "Request payload failed schema validation: {}",
        ...
        let mut topic_param_map = self.base_topic_params();
        topic_param_map.insert("method_name".to_string(), "callThreeDurations".to_string());
        let request_topic: String = strfmt(
        ...
        .unwrap();
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callThreeDurations/response",
            &topic_param_map,
        )
        .unwrap();
        let msg = message::request(&request_topic, &data, correlation_id, response_topic).unwrap();
    ...
    async fn start_call_one_binary(
        ...
        if let Err(e) = data.validate_schema() {
            error!(
                "Request payload for callOneBinary failed schema validation, not sending: {}",
                e
            );
            let _ = sender.send(MethodReturnCode::ClientSerializationError(format!(
                "Request payload failed schema validation: {}",
        ...
        let mut topic_param_map = self.base_topic_params();
        topic_param_map.insert("method_name".to_string(), "callOneBinary".to_string());
        let request_topic: String = strfmt(
        ...
        .unwrap();
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callOneBinary/response",
            &topic_param_map,
        )
        .unwrap();
        let msg = message::request(&request_topic, &data, correlation_id, response_topic).unwrap();
    ...
    async fn start_call_optional_binary(
        ...
        if let Err(e) = data.validate_schema() {
            error!(
                "Request payload for callOptionalBinary failed schema validation, not sending: {}",
                e
            );
            let _ = sender.send(MethodReturnCode::ClientSerializationError(format!(
                "Request payload failed schema validation: {}",
        ...
        let mut topic_param_map = self.base_topic_params();
        topic_param_map.insert("method_name".to_string(), "callOptionalBinary".to_string());
        let request_topic: String = strfmt(
        ...
        .unwrap();
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callOptionalBinary/response",
            &topic_param_map,
        )
        .unwrap();
        let msg = message::request(&request_topic, &data, correlation_id, response_topic).unwrap();
    ...
    async fn start_call_three_binaries(
        ...
        if let Err(e) = data.validate_schema() {
            error!(
                "Request payload for callThreeBinaries failed schema validation, not sending: {}",
                e
            );
            let _ = sender.send(MethodReturnCode::ClientSerializationError(format!(
                "Request payload failed schema validation: {}",
        ...
        let mut topic_param_map = self.base_topic_params();
        topic_param_map.insert("method_name".to_string(), "callThreeBinaries".to_string());
        let request_topic: String = strfmt(
        ...
        .unwrap();
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callThreeBinaries/response",
            &topic_param_map,
        )
        .unwrap();
        let msg = message::request(&request_topic, &data, correlation_id, response_topic).unwrap();
    ...
    async fn start_call_one_list_of_integers(
        ...
        if let Err(e) = data.validate_schema() {
            error!("Request payload for callOneListOfIntegers failed schema validation, not sending: {}", e);
            let _ = sender.send(MethodReturnCode::ClientSerializationError(format!(
                "Request payload failed schema validation: {}",
                e
            )));
        ...
        .unwrap();
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callOneListOfIntegers/response",
            &topic_param_map,
        )
        .unwrap();
        let msg = message::request(&request_topic, &data, correlation_id, response_topic).unwrap();
    ...
    async fn start_call_optional_list_of_floats(
        ...
        if let Err(e) = data.validate_schema() {
            error!("Request payload for callOptionalListOfFloats failed schema validation, not sending: {}", e);
            let _ = sender.send(MethodReturnCode::ClientSerializationError(format!(
                "Request payload failed schema validation: {}",
                e
            )));
        ...
        .unwrap();
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callOptionalListOfFloats/response",
            &topic_param_map,
        )
        .unwrap();
        let msg = message::request(&request_topic, &data, correlation_id, response_topic).unwrap();
    ...
    async fn start_call_two_lists(
        ...
        if let Err(e) = data.validate_schema() {
            error!(
                "Request payload for callTwoLists failed schema validation, not sending: {}",
                e
            );
            let _ = sender.send(MethodReturnCode::ClientSerializationError(format!(
                "Request payload failed schema validation: {}",
        ...
        let mut topic_param_map = self.base_topic_params();
        topic_param_map.insert("method_name".to_string(), "callTwoLists".to_string());
        let request_topic: String = strfmt(
        ...
        .unwrap();
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/callTwoLists/response",
            &topic_param_map,
        )
        .unwrap();
        let msg = message::request(&request_topic, &data, correlation_id, response_topic).unwrap();
    ...
    pub async fn run_loop(&mut self) -> Result<(), JoinError> {
        ...
        // Set up the property change request handling task for 'read_write_integer'.
        if let Some(request_rx) = props.read_write_integer.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            topic_param_map.insert(
                "property_name".to_string(),
                "read_write_integer".to_string(),
            ...
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_write_integer/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
                ...
                update_topic,
                response_topic,
                props.read_write_integer_version.clone(),
                |value| ReadWriteIntegerProperty { value: value },
                |resp_obj: ReadWriteIntegerProperty| resp_obj.value,
            ));
        }

        // Set up the property change request handling task for 'read_only_integer'.
        if let Some(request_rx) = props.read_only_integer.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_only_integer/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
                ...
                update_topic,
                response_topic,
                props.read_only_integer_version.clone(),
                |value| ReadOnlyIntegerProperty { value: value },
                |resp_obj: ReadOnlyIntegerProperty| resp_obj.value,
            ));
        }

        // Set up the property change request handling task for 'read_write_optional_integer'.
        if let Some(request_rx) = props.read_write_optional_integer.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            topic_param_map.insert(
                "property_name".to_string(),
                "read_write_optional_integer".to_string(),
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_write_optional_integer/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
                ...
                |value| ReadWriteOptionalIntegerProperty { value: value },
                |resp_obj: ReadWriteOptionalIntegerProperty| resp_obj.value,
            ));
        }

        // Set up the property change request handling task for 'read_write_two_integers'.
        if let Some(request_rx) = props.read_write_two_integers.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            topic_param_map.insert(
                "property_name".to_string(),
                "read_write_two_integers".to_string(),
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_write_two_integers/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
        ...
        // Set up the property change request handling task for 'read_only_string'.
        if let Some(request_rx) = props.read_only_string.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_only_string/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
                ...
                update_topic,
                response_topic,
                props.read_only_string_version.clone(),
                |value| ReadOnlyStringProperty { value: value },
                |resp_obj: ReadOnlyStringProperty| resp_obj.value,
            ));
        }

        // Set up the property change request handling task for 'read_write_string'.
        if let Some(request_rx) = props.read_write_string.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_write_string/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
                ...
                update_topic,
                response_topic,
                props.read_write_string_version.clone(),
                |value| ReadWriteStringProperty { value: value },
                |resp_obj: ReadWriteStringProperty| resp_obj.value,
            ));
        }

        // Set up the property change request handling task for 'read_write_optional_string'.
        if let Some(request_rx) = props.read_write_optional_string.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            topic_param_map.insert(
                "property_name".to_string(),
                "read_write_optional_string".to_string(),
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_write_optional_string/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
                ...
                |value| ReadWriteOptionalStringProperty { value: value },
                |resp_obj: ReadWriteOptionalStringProperty| resp_obj.value,
            ));
        }

        // Set up the property change request handling task for 'read_write_two_strings'.
        if let Some(request_rx) = props.read_write_two_strings.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            topic_param_map.insert(
                "property_name".to_string(),
                "read_write_two_strings".to_string(),
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_write_two_strings/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
                ...
                update_topic,
                response_topic,
                props.read_write_two_strings_version.clone(),
                |value| value,
                |resp_obj| resp_obj,
            ));
        }

        // Set up the property change request handling task for 'read_write_struct'.
        if let Some(request_rx) = props.read_write_struct.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_write_struct/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
                ...
                update_topic,
                response_topic,
                props.read_write_struct_version.clone(),
                |value| ReadWriteStructProperty { value: value },
                |resp_obj: ReadWriteStructProperty| resp_obj.value,
            ));
        }

        // Set up the property change request handling task for 'read_write_optional_struct'.
        if let Some(request_rx) = props.read_write_optional_struct.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            topic_param_map.insert(
                "property_name".to_string(),
                "read_write_optional_struct".to_string(),
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_write_optional_struct/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
                ...
                |value| ReadWriteOptionalStructProperty { value: value },
                |resp_obj: ReadWriteOptionalStructProperty| resp_obj.value,
            ));
        }

        // Set up the property change request handling task for 'read_write_two_structs'.
        if let Some(request_rx) = props.read_write_two_structs.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            topic_param_map.insert(
                "property_name".to_string(),
                "read_write_two_structs".to_string(),
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_write_two_structs/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
                ...
                update_topic,
                response_topic,
                props.read_write_two_structs_version.clone(),
                |value| value,
                |resp_obj| resp_obj,
            ));
        }

        // Set up the property change request handling task for 'read_only_enum'.
        if let Some(request_rx) = props.read_only_enum.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_only_enum/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
                ...
                update_topic,
                response_topic,
                props.read_only_enum_version.clone(),
                |value| ReadOnlyEnumProperty { value: value },
                |resp_obj: ReadOnlyEnumProperty| resp_obj.value,
            ));
        }

        // Set up the property change request handling task for 'read_write_enum'.
        if let Some(request_rx) = props.read_write_enum.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_write_enum/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
                ...
                update_topic,
                response_topic,
                props.read_write_enum_version.clone(),
                |value| ReadWriteEnumProperty { value: value },
                |resp_obj: ReadWriteEnumProperty| resp_obj.value,
            ));
        }

        // Set up the property change request handling task for 'read_write_optional_enum'.
        if let Some(request_rx) = props.read_write_optional_enum.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            topic_param_map.insert(
                "property_name".to_string(),
                "read_write_optional_enum".to_string(),
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_write_optional_enum/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
                ...
                |value| ReadWriteOptionalEnumProperty { value: value },
                |resp_obj: ReadWriteOptionalEnumProperty| resp_obj.value,
            ));
        }

        // Set up the property change request handling task for 'read_write_two_enums'.
        if let Some(request_rx) = props.read_write_two_enums.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            topic_param_map.insert(
                "property_name".to_string(),
                "read_write_two_enums".to_string(),
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_write_two_enums/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
                ...
                update_topic,
                response_topic,
                props.read_write_two_enums_version.clone(),
                |value| value,
                |resp_obj| resp_obj,
            ));
        }

        // Set up the property change request handling task for 'read_write_datetime'.
        if let Some(request_rx) = props.read_write_datetime.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            topic_param_map.insert(
                "property_name".to_string(),
                "read_write_datetime".to_string(),
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_write_datetime/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
                ...
                update_topic,
                response_topic,
                props.read_write_datetime_version.clone(),
                |value| ReadWriteDatetimeProperty { value: value },
                |resp_obj: ReadWriteDatetimeProperty| resp_obj.value,
            ));
        }

        // Set up the property change request handling task for 'read_write_optional_datetime'.
        if let Some(request_rx) = props.read_write_optional_datetime.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            topic_param_map.insert(
                "property_name".to_string(),
                "read_write_optional_datetime".to_string(),
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_write_optional_datetime/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
                ...
                |value| ReadWriteOptionalDatetimeProperty { value: value },
                |resp_obj: ReadWriteOptionalDatetimeProperty| resp_obj.value,
            ));
        }

        // Set up the property change request handling task for 'read_write_two_datetimes'.
        if let Some(request_rx) = props.read_write_two_datetimes.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            topic_param_map.insert(
                "property_name".to_string(),
                "read_write_two_datetimes".to_string(),
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_write_two_datetimes/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
        ...
        // Set up the property change request handling task for 'read_write_duration'.
        if let Some(request_rx) = props.read_write_duration.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            topic_param_map.insert(
                "property_name".to_string(),
                "read_write_duration".to_string(),
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_write_duration/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
                ...
                update_topic,
                response_topic,
                props.read_write_duration_version.clone(),
                |value| ReadWriteDurationProperty { value: value },
                |resp_obj: ReadWriteDurationProperty| resp_obj.value,
            ));
        }

        // Set up the property change request handling task for 'read_write_optional_duration'.
        if let Some(request_rx) = props.read_write_optional_duration.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            topic_param_map.insert(
                "property_name".to_string(),
                "read_write_optional_duration".to_string(),
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_write_optional_duration/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
                ...
                |value| ReadWriteOptionalDurationProperty { value: value },
                |resp_obj: ReadWriteOptionalDurationProperty| resp_obj.value,
            ));
        }

        // Set up the property change request handling task for 'read_write_two_durations'.
        if let Some(request_rx) = props.read_write_two_durations.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            topic_param_map.insert(
                "property_name".to_string(),
                "read_write_two_durations".to_string(),
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_write_two_durations/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
        ...
        // Set up the property change request handling task for 'read_write_binary'.
        if let Some(request_rx) = props.read_write_binary.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_write_binary/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
                ...
                update_topic,
                response_topic,
                props.read_write_binary_version.clone(),
                |value| ReadWriteBinaryProperty { value: value },
                |resp_obj: ReadWriteBinaryProperty| resp_obj.value,
            ));
        }

        // Set up the property change request handling task for 'read_write_optional_binary'.
        if let Some(request_rx) = props.read_write_optional_binary.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            topic_param_map.insert(
                "property_name".to_string(),
                "read_write_optional_binary".to_string(),
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_write_optional_binary/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
                ...
                |value| ReadWriteOptionalBinaryProperty { value: value },
                |resp_obj: ReadWriteOptionalBinaryProperty| resp_obj.value,
            ));
        }

        // Set up the property change request handling task for 'read_write_two_binaries'.
        if let Some(request_rx) = props.read_write_two_binaries.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            topic_param_map.insert(
                "property_name".to_string(),
                "read_write_two_binaries".to_string(),
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_write_two_binaries/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
        ...
        // Set up the property change request handling task for 'read_write_list_of_strings'.
        if let Some(request_rx) = props.read_write_list_of_strings.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            topic_param_map.insert(
                "property_name".to_string(),
                "read_write_list_of_strings".to_string(),
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_write_list_of_strings/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
                ...
                |value| ReadWriteListOfStringsProperty { value: value },
                |resp_obj: ReadWriteListOfStringsProperty| resp_obj.value,
            ));
        }

        // Set up the property change request handling task for 'read_write_lists'.
        if let Some(request_rx) = props.read_write_lists.take_request_receiver() {
            let mut topic_param_map = self.base_topic_params();
            ...
            .unwrap();
            let response_topic = strfmt(
                "client/{client_id}/testable/property/read_write_lists/update/response",
                &topic_param_map,
            )
            .unwrap();
            tokio::spawn(Self::run_property_update_request_handler(
                ...
                update_topic,
                response_topic,
                props.read_write_lists_version.clone(),
                |value| value,
                |resp_obj| resp_obj,
            ));
        }
            ...
            loop {
                ...
                if let Some(subscription_id) = msg.subscription_id {
                    match subscription_id {
                            ...
                            match serde_json::from_slice::<SingleIntSignalPayload>(&msg.payload) {
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'singleInt' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                        ...
                        _i if sub_ids.json_schema_validated_int_signal == Some(_i) => {
                            debug!("Received jsonSchemaValidatedInt signal message");
                            // Find broadcast channel.
                            let chan = sig_chans.json_schema_validated_int_sender.clone();

                            // Single argument, extract it from payload and send to channel.
                            match serde_json::from_slice::<JsonSchemaValidatedIntSignalPayload>(
                                &msg.payload,
                            ) {
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'jsonSchemaValidatedInt' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                                    let _send_result = chan.send(pl.value);
                                }
                                Err(e) => {
                                    warn!("Failed to deserialize '{}' into JsonSchemaValidatedIntSignalPayload: {}", String::from_utf8_lossy(&msg.payload), e);
                                    continue;
                                }
                            }
                        }
                        ...
                        _i if sub_ids.single_optional_int_signal == Some(_i) => {
                            ...
                            match serde_json::from_slice::<SingleOptionalIntSignalPayload>(
                                ...
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'singleOptionalInt' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                                    let _send_result = chan.send(pl.value);
                                }
                        ...
                        _i if sub_ids.three_integers_signal == Some(_i) => {
                            ...
                            match serde_json::from_slice::<ThreeIntegersSignalPayload>(&msg.payload)
                            {
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'threeIntegers' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                        ...
                        _i if sub_ids.single_string_signal == Some(_i) => {
                            ...
                            match serde_json::from_slice::<SingleStringSignalPayload>(&msg.payload)
                            {
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'singleString' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                                    let _send_result = chan.send(pl.value);
                                }
                        ...
                        _i if sub_ids.json_schema_validated_string_signal == Some(_i) => {
                            debug!("Received jsonSchemaValidatedString signal message");
                            // Find broadcast channel.
                            let chan = sig_chans.json_schema_validated_string_sender.clone();

                            // Single argument, extract it from payload and send to channel.
                            match serde_json::from_slice::<JsonSchemaValidatedStringSignalPayload>(
                                &msg.payload,
                            ) {
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'jsonSchemaValidatedString' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                                    let _send_result = chan.send(pl.value);
                                }
                                Err(e) => {
                                    warn!("Failed to deserialize '{}' into JsonSchemaValidatedStringSignalPayload: {}", String::from_utf8_lossy(&msg.payload), e);
                                    continue;
                                }
                            }
                        }
                        ...
                        _i if sub_ids.single_optional_string_signal == Some(_i) => {
                            ...
                            match serde_json::from_slice::<SingleOptionalStringSignalPayload>(
                                ...
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'singleOptionalString' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                                    let _send_result = chan.send(pl.value);
                                }
                        ...
                        _i if sub_ids.three_strings_signal == Some(_i) => {
                            ...
                            match serde_json::from_slice::<ThreeStringsSignalPayload>(&msg.payload)
                            {
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'threeStrings' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                                    let _send_result = chan.send(pl);
                                }
                        ...
                        _i if sub_ids.single_enum_signal == Some(_i) => {
                            ...
                            match serde_json::from_slice::<SingleEnumSignalPayload>(&msg.payload) {
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'singleEnum' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                                    let _send_result = chan.send(pl.value);
                                }
                        ...
                        _i if sub_ids.single_optional_enum_signal == Some(_i) => {
                            ...
                            match serde_json::from_slice::<SingleOptionalEnumSignalPayload>(
                                ...
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'singleOptionalEnum' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                                    let _send_result = chan.send(pl.value);
                                }
                        ...
                        _i if sub_ids.three_enums_signal == Some(_i) => {
                            ...
                            match serde_json::from_slice::<ThreeEnumsSignalPayload>(&msg.payload) {
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'threeEnums' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                                    let _send_result = chan.send(pl);
                                }
                        ...
                        _i if sub_ids.single_struct_signal == Some(_i) => {
                            ...
                            match serde_json::from_slice::<SingleStructSignalPayload>(&msg.payload)
                            {
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'singleStruct' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                                    let _send_result = chan.send(pl.value);
                                }
                        ...
                        _i if sub_ids.single_optional_struct_signal == Some(_i) => {
                            ...
                            match serde_json::from_slice::<SingleOptionalStructSignalPayload>(
                                ...
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'singleOptionalStruct' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                                    let _send_result = chan.send(pl.value);
                                }
                        ...
                        _i if sub_ids.three_structs_signal == Some(_i) => {
                            ...
                            match serde_json::from_slice::<ThreeStructsSignalPayload>(&msg.payload)
                            {
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'threeStructs' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                                    let _send_result = chan.send(pl);
                                }
                        ...
                        _i if sub_ids.single_date_time_signal == Some(_i) => {
                            ...
                            match serde_json::from_slice::<SingleDateTimeSignalPayload>(
                                ...
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'singleDateTime' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                                    let _send_result = chan.send(pl.value);
                                }
                        ...
                        _i if sub_ids.single_optional_datetime_signal == Some(_i) => {
                            ...
                            match serde_json::from_slice::<SingleOptionalDatetimeSignalPayload>(
                                ...
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'singleOptionalDatetime' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                                    let _send_result = chan.send(pl.value);
                                }
                        ...
                        _i if sub_ids.three_date_times_signal == Some(_i) => {
                            ...
                            match serde_json::from_slice::<ThreeDateTimesSignalPayload>(
                                ...
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'threeDateTimes' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                                    let _send_result = chan.send(pl);
                                }
                        ...
                        _i if sub_ids.single_duration_signal == Some(_i) => {
                            ...
                            match serde_json::from_slice::<SingleDurationSignalPayload>(
                                ...
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'singleDuration' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                                    let _send_result = chan.send(pl.value);
                                }
                        ...
                        _i if sub_ids.single_optional_duration_signal == Some(_i) => {
                            ...
                            match serde_json::from_slice::<SingleOptionalDurationSignalPayload>(
                                ...
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'singleOptionalDuration' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                                    let _send_result = chan.send(pl.value);
                                }
                        ...
                        _i if sub_ids.three_durations_signal == Some(_i) => {
                            ...
                            match serde_json::from_slice::<ThreeDurationsSignalPayload>(
                                ...
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'threeDurations' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                                    let _send_result = chan.send(pl);
                                }
                        ...
                        _i if sub_ids.single_binary_signal == Some(_i) => {
                            ...
                            match serde_json::from_slice::<SingleBinarySignalPayload>(&msg.payload)
                            {
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'singleBinary' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                                    let _send_result = chan.send(pl.value);
                                }
                        ...
                        _i if sub_ids.single_optional_binary_signal == Some(_i) => {
                            ...
                            match serde_json::from_slice::<SingleOptionalBinarySignalPayload>(
                                ...
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'singleOptionalBinary' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                                    let _send_result = chan.send(pl.value);
                                }
                        ...
                        _i if sub_ids.three_binaries_signal == Some(_i) => {
                            ...
                            match serde_json::from_slice::<ThreeBinariesSignalPayload>(&msg.payload)
                            {
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'threeBinaries' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                                    let _send_result = chan.send(pl);
                                }
                        ...
                        _i if sub_ids.single_array_of_integers_signal == Some(_i) => {
                            ...
                            match serde_json::from_slice::<SingleArrayOfIntegersSignalPayload>(
                                ...
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'singleArrayOfIntegers' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                        ...
                        _i if sub_ids.single_optional_array_of_strings_signal == Some(_i) => {
                            ...
                            match serde_json::from_slice::<SingleOptionalArrayOfStringsSignalPayload>(
                                ...
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'singleOptionalArrayOfStrings' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                                    let _send_result = chan.send(pl.values);
                                }
                        ...
                        _i if sub_ids.array_of_every_type_signal == Some(_i) => {
                            ...
                            match serde_json::from_slice::<ArrayOfEveryTypeSignalPayload>(
                                ...
                                Ok(pl) => {
                                    if let Err(e) = pl.validate_schema() {
                                        warn!("Received 'arrayOfEveryType' signal payload failed schema validation: {}", e);
                                        continue;
                                    }
                                    let _send_result = chan.send(pl);
                                }
                        ...
                        _i if _i == sub_ids.read_write_integer_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadWriteIntegerProperty>(
                                    ...
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_write_integer' property value failed schema validation: {}", e);
                                            return;
                                        }
                        ...
                        _i if _i == sub_ids.read_only_integer_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadOnlyIntegerProperty>(
                                    ...
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_only_integer' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
                        ...
                        _i if _i == sub_ids.read_write_optional_integer_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadWriteOptionalIntegerProperty>(
                                    ...
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_write_optional_integer' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
                                        let mut guard =
                        ...
                        _i if _i == sub_ids.read_write_two_integers_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadWriteTwoIntegersProperty>(
                                    ...
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_write_two_integers' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
                                        let mut guard =
                        ...
                        _i if _i == sub_ids.read_only_string_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadOnlyStringProperty>(&msg.payload)
                                {
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_only_string' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
                        ...
                        _i if _i == sub_ids.read_write_string_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadWriteStringProperty>(
                                    ...
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_write_string' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
                        ...
                        _i if _i == sub_ids.read_write_optional_string_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadWriteOptionalStringProperty>(
                                    ...
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_write_optional_string' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
                                        let mut guard =
                        ...
                        _i if _i == sub_ids.read_write_two_strings_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadWriteTwoStringsProperty>(
                                    ...
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_write_two_strings' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
                                        let mut guard =
                        ...
                        _i if _i == sub_ids.read_write_struct_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadWriteStructProperty>(
                                    ...
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_write_struct' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
                        ...
                        _i if _i == sub_ids.read_write_optional_struct_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadWriteOptionalStructProperty>(
                                    ...
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_write_optional_struct' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
                                        let mut guard =
                        ...
                        _i if _i == sub_ids.read_write_two_structs_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadWriteTwoStructsProperty>(
                                    ...
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_write_two_structs' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
                                        let mut guard =
                        ...
                        _i if _i == sub_ids.read_only_enum_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadOnlyEnumProperty>(&msg.payload) {
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_only_enum' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
                        ...
                        _i if _i == sub_ids.read_write_enum_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadWriteEnumProperty>(&msg.payload)
                                {
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_write_enum' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
                        ...
                        _i if _i == sub_ids.read_write_optional_enum_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadWriteOptionalEnumProperty>(
                                    ...
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_write_optional_enum' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
                                        let mut guard =
                        ...
                        _i if _i == sub_ids.read_write_two_enums_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadWriteTwoEnumsProperty>(
                                    ...
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_write_two_enums' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
                                        let mut guard =
                        ...
                        _i if _i == sub_ids.read_write_datetime_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadWriteDatetimeProperty>(
                                    ...
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_write_datetime' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
                                        let mut guard =
                        ...
                        _i if _i == sub_ids.read_write_optional_datetime_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadWriteOptionalDatetimeProperty>(
                                    ...
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_write_optional_datetime' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
                                        let mut guard =
                        ...
                        _i if _i == sub_ids.read_write_two_datetimes_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadWriteTwoDatetimesProperty>(
                                    ...
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_write_two_datetimes' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
                                        let mut guard =
                        ...
                        _i if _i == sub_ids.read_write_duration_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadWriteDurationProperty>(
                                    ...
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_write_duration' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
                                        let mut guard =
                        ...
                        _i if _i == sub_ids.read_write_optional_duration_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadWriteOptionalDurationProperty>(
                                    ...
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_write_optional_duration' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
                                        let mut guard =
                        ...
                        _i if _i == sub_ids.read_write_two_durations_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadWriteTwoDurationsProperty>(
                                    ...
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_write_two_durations' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
                                        let mut guard =
                        ...
                        _i if _i == sub_ids.read_write_binary_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadWriteBinaryProperty>(
                                    ...
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_write_binary' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
                        ...
                        _i if _i == sub_ids.read_write_optional_binary_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadWriteOptionalBinaryProperty>(
                                    ...
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_write_optional_binary' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
                                        let mut guard =
                        ...
                        _i if _i == sub_ids.read_write_two_binaries_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadWriteTwoBinariesProperty>(
                                    ...
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_write_two_binaries' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
                                        let mut guard =
                        ...
                        _i if _i == sub_ids.read_write_list_of_strings_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadWriteListOfStringsProperty>(
                                    ...
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_write_list_of_strings' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
                                        let mut guard =
                        ...
                        _i if _i == sub_ids.read_write_lists_property_value => {
                            ...
                            tokio::spawn(async move {
                                ...
                                match serde_json::from_slice::<ReadWriteListsProperty>(&msg.payload)
                                {
                                    Ok(pl) => {
                                        if let Err(e) = pl.validate_schema() {
                                            warn!("Received 'read_write_lists' property value failed schema validation: {}", e);
                                            return;
                                        }
                                        // Get a write-guard and set the local copy of the property value.
...
mod tests {
    ...
    async fn mock_client() {
        ...
        let mut client = TestableClient::new(mock_mqtt.clone(), discovery_info).await;
        ...
        {
            // Test calling the callWithNothing method.
            mock_mqtt.clear_published_messages();
            let _rx = client.start_call_with_nothing().await;
        ...
        {
            // Test calling the callOneInteger method.
            mock_mqtt.clear_published_messages();
            let _rx = client.start_call_one_integer(42).await;
            let sent_message = mock_mqtt
                .last_published_message()
                .expect("Expected a method request message to be published");
        ...
        {
            // Test calling the callOptionalInteger method.
            mock_mqtt.clear_published_messages();
            let _rx = client.start_call_optional_integer(Some(42)).await;
            let sent_message = mock_mqtt
                .last_published_message()
                .expect("Expected a method request message to be published");
        ...
        {
            // Test calling the callThreeIntegers method.
            mock_mqtt.clear_published_messages();
            let _rx = client.start_call_three_integers(42, 42, Some(42)).await;
            let sent_message = mock_mqtt
                .last_published_message()
                .expect("Expected a method request message to be published");
        ...
        {
            // Test calling the callOneString method.
            mock_mqtt.clear_published_messages();
            let _rx = client.start_call_one_string("apples".to_string()).await;
            let sent_message = mock_mqtt
                .last_published_message()
                .expect("Expected a method request message to be published");
        ...
        {
            // Test calling the callOptionalString method.
            mock_mqtt.clear_published_messages();
            let _rx = client
                .start_call_optional_string(Some("apples".to_string()))
                .await;
            let sent_message = mock_mqtt
                .last_published_message()
                .expect("Expected a method request message to be published");
        ...
        {
            // Test calling the callThreeStrings method.
            mock_mqtt.clear_published_messages();
            let _rx = client
                .start_call_three_strings(
                    "apples".to_string(),
        ...
        {
            // Test calling the callOneEnum method.
            mock_mqtt.clear_published_messages();
            let _rx = client.start_call_one_enum(Numbers::One).await;
            let sent_message = mock_mqtt
                .last_published_message()
                .expect("Expected a method request message to be published");
        ...
        {
            // Test calling the callOptionalEnum method.
            mock_mqtt.clear_published_messages();
            let _rx = client.start_call_optional_enum(Some(Numbers::One)).await;
            let sent_message = mock_mqtt
                .last_published_message()
                .expect("Expected a method request message to be published");
        ...
        {
            // Test calling the callThreeEnums method.
            mock_mqtt.clear_published_messages();
            let _rx = client
                .start_call_three_enums(Numbers::One, Numbers::One, Some(Numbers::One))
                .await;
            let sent_message = mock_mqtt
                .last_published_message()
                .expect("Expected a method request message to be published");
        ...
        {
            // Test calling the callOneStruct method.
            mock_mqtt.clear_published_messages();
            let _rx = client
                .start_call_one_struct(AllTypes {
                    the_bool: true,
                    the_int: 42,
                    the_number: 3.14,
                    the_str: "apples".to_string(),
        ...
        {
            // Test calling the callOptionalStruct method.
            mock_mqtt.clear_published_messages();
            let _rx = client
                .start_call_optional_struct(Some(AllTypes {
                    the_bool: true,
                    the_int: 42,
                    the_number: 3.14,
                    the_str: "apples".to_string(),
        ...
        {
            // Test calling the callThreeStructs method.
            mock_mqtt.clear_published_messages();
            let _rx = client
                .start_call_three_structs(
                    Some(AllTypes {
                        the_bool: true,
                        the_int: 42,
                        the_number: 3.14,
        ...
        {
            // Test calling the callOneDateTime method.
            mock_mqtt.clear_published_messages();
            let _rx = client.start_call_one_date_time(chrono::Utc::now()).await;
            let sent_message = mock_mqtt
                .last_published_message()
                .expect("Expected a method request message to be published");
        ...
        {
            // Test calling the callOptionalDateTime method.
            mock_mqtt.clear_published_messages();
            let _rx = client
                .start_call_optional_date_time(Some(chrono::Utc::now()))
                .await;
            let sent_message = mock_mqtt
                .last_published_message()
                .expect("Expected a method request message to be published");
        ...
        {
            // Test calling the callThreeDateTimes method.
            mock_mqtt.clear_published_messages();
            let _rx = client
                .start_call_three_date_times(
                    chrono::Utc::now(),
                    chrono::Utc::now(),
                    Some(chrono::Utc::now()),
                )
        ...
        {
            // Test calling the callOneDuration method.
            mock_mqtt.clear_published_messages();
            let _rx = client
                .start_call_one_duration(chrono::Duration::seconds(3536))
                .await;
            let sent_message = mock_mqtt
                .last_published_message()
                .expect("Expected a method request message to be published");
        ...
        {
            // Test calling the callOptionalDuration method.
            mock_mqtt.clear_published_messages();
            let _rx = client
                .start_call_optional_duration(Some(chrono::Duration::seconds(3536)))
                .await;
            let sent_message = mock_mqtt
                .last_published_message()
                .expect("Expected a method request message to be published");
        ...
        {
            // Test calling the callThreeDurations method.
            mock_mqtt.clear_published_messages();
            let _rx = client
                .start_call_three_durations(
                    chrono::Duration::seconds(3536),
                    chrono::Duration::seconds(3536),
        ...
        {
            // Test calling the callOneBinary method.
            mock_mqtt.clear_published_messages();
            let _rx = client
                .start_call_one_binary(vec![101, 120, 97, 109, 112, 108, 101])
                .await;
            let sent_message = mock_mqtt
                .last_published_message()
                .expect("Expected a method request message to be published");
        ...
        {
            // Test calling the callOptionalBinary method.
            mock_mqtt.clear_published_messages();
            let _rx = client
                .start_call_optional_binary(Some(vec![101, 120, 97, 109, 112, 108, 101]))
                .await;
            let sent_message = mock_mqtt
                .last_published_message()
                .expect("Expected a method request message to be published");
        ...
        {
            // Test calling the callThreeBinaries method.
            mock_mqtt.clear_published_messages();
            let _rx = client
                .start_call_three_binaries(
                    vec![101, 120, 97, 109, 112, 108, 101],
                    vec![101, 120, 97, 109, 112, 108, 101],
        ...
        {
            // Test calling the callOneListOfIntegers method.
            mock_mqtt.clear_published_messages();
            let _rx = client.start_call_one_list_of_integers(vec![42, 2022]).await;
            let sent_message = mock_mqtt
                .last_published_message()
                .expect("Expected a method request message to be published");
        ...
        {
            // Test calling the callOptionalListOfFloats method.
            mock_mqtt.clear_published_messages();
            let _rx = client
                .start_call_optional_list_of_floats(Some(vec![3.14, 1.0, 1.0]))
                .await;
            let sent_message = mock_mqtt
                .last_published_message()
                .expect("Expected a method request message to be published");
        ...
        {
            // Test calling the callTwoLists method.
            mock_mqtt.clear_published_messages();
            let _rx = client
                .start_call_two_lists(
        ...
        {
            // Test setting the read_write_integer property if it is not read-only.
            // Create an example value to set the property to.
            let read_write_integer_new_value = 42;
            mock_mqtt.clear_published_messages();
            let read_write_integer_handle = client.get_read_write_integer_handle();
            {
                // Guard scope
                let mut guard = read_write_integer_handle.write().await;
                *guard = read_write_integer_new_value;
            ...
            let sent_message = mock_mqtt.last_published_message().expect(
                "Expected a property update message for 'read_write_integer' to be published",
            );
            assert!(sent_message.response_topic.is_some(), "Expected response_topic to be set on property update message for 'read_write_integer'");
            let response_topic = sent_message.response_topic.as_ref().unwrap();
            assert!(!response_topic.contains('+'), "In the property update message for 'read_write_integer', the response_topic should not contain '+'");
            assert!(!response_topic.contains('#'), "In the property update message for 'read_write_integer', the response_topic should not contain '#'");

            assert!(sent_message.topic.contains(server_topic_param_map.get("prefix").unwrap()), "Expected the property update for 'read_write_integer' to contain the topic parameter 'prefix'");
        }

        {
            // Test setting the read_write_optional_integer property if it is not read-only.
            // Create an example value to set the property to.
            let read_write_optional_integer_new_value = Some(42);
            mock_mqtt.clear_published_messages();
            let read_write_optional_integer_handle =
                client.get_read_write_optional_integer_handle();
            {
                // Guard scope
                let mut guard = read_write_optional_integer_handle.write().await;
                *guard = read_write_optional_integer_new_value;
            } // drop guard should send the mqtt request to update the property value on the server.
            sleep(Duration::from_millis(50)).await; // Its not so much the sleep time as the await that allows other async code to complete.

            let sent_message = mock_mqtt.last_published_message().expect("Expected a property update message for 'read_write_optional_integer' to be published");
            assert!(sent_message.response_topic.is_some(), "Expected response_topic to be set on property update message for 'read_write_optional_integer'");
            let response_topic = sent_message.response_topic.as_ref().unwrap();
            assert!(!response_topic.contains('+'), "In the property update message for 'read_write_optional_integer', the response_topic should not contain '+'");
            assert!(!response_topic.contains('#'), "In the property update message for 'read_write_optional_integer', the response_topic should not contain '#'");

            assert!(sent_message.topic.contains(server_topic_param_map.get("prefix").unwrap()), "Expected the property update for 'read_write_optional_integer' to contain the topic parameter 'prefix'");
        }

        {
            // Test setting the read_write_two_integers property if it is not read-only.
            // Create an example value to set the property to.
            ...
            mock_mqtt.clear_published_messages();
            let read_write_two_integers_handle = client.get_read_write_two_integers_handle();
            {
                // Guard scope
                let mut guard = read_write_two_integers_handle.write().await;
                *guard = read_write_two_integers_new_value;
            } // drop guard should send the mqtt request to update the property value on the server.
            sleep(Duration::from_millis(50)).await; // Its not so much the sleep time as the await that allows other async code to complete.

            let sent_message = mock_mqtt.last_published_message().expect(
                "Expected a property update message for 'read_write_two_integers' to be published",
            );
            assert!(sent_message.response_topic.is_some(), "Expected response_topic to be set on property update message for 'read_write_two_integers'");
            let response_topic = sent_message.response_topic.as_ref().unwrap();
            assert!(!response_topic.contains('+'), "In the property update message for 'read_write_two_integers', the response_topic should not contain '+'");
            assert!(!response_topic.contains('#'), "In the property update message for 'read_write_two_integers', the response_topic should not contain '#'");

            assert!(sent_message.topic.contains(server_topic_param_map.get("prefix").unwrap()), "Expected the property update for 'read_write_two_integers' to contain the topic parameter 'prefix'");
        }

        {
            // Test setting the read_write_string property if it is not read-only.
            // Create an example value to set the property to.
            let read_write_string_new_value = "apples".to_string();
            mock_mqtt.clear_published_messages();
            let read_write_string_handle = client.get_read_write_string_handle();
            {
                // Guard scope
                let mut guard = read_write_string_handle.write().await;
                *guard = read_write_string_new_value;
            } // drop guard should send the mqtt request to update the property value on the server.
            sleep(Duration::from_millis(50)).await; // Its not so much the sleep time as the await that allows other async code to complete.

            let sent_message = mock_mqtt.last_published_message().expect(
                "Expected a property update message for 'read_write_string' to be published",
            );
            assert!(sent_message.response_topic.is_some(), "Expected response_topic to be set on property update message for 'read_write_string'");
            let response_topic = sent_message.response_topic.as_ref().unwrap();
            assert!(!response_topic.contains('+'), "In the property update message for 'read_write_string', the response_topic should not contain '+'");
            assert!(!response_topic.contains('#'), "In the property update message for 'read_write_string', the response_topic should not contain '#'");

            assert!(sent_message.topic.contains(server_topic_param_map.get("prefix").unwrap()), "Expected the property update for 'read_write_string' to contain the topic parameter 'prefix'");
        }

        {
            // Test setting the read_write_optional_string property if it is not read-only.
            // Create an example value to set the property to.
            let read_write_optional_string_new_value = Some("apples".to_string());
            mock_mqtt.clear_published_messages();
            let read_write_optional_string_handle = client.get_read_write_optional_string_handle();
            {
                // Guard scope
                let mut guard = read_write_optional_string_handle.write().await;
                *guard = read_write_optional_string_new_value;
            } // drop guard should send the mqtt request to update the property value on the server.
            sleep(Duration::from_millis(50)).await; // Its not so much the sleep time as the await that allows other async code to complete.

            let sent_message = mock_mqtt.last_published_message().expect("Expected a property update message for 'read_write_optional_string' to be published");
            assert!(sent_message.response_topic.is_some(), "Expected response_topic to be set on property update message for 'read_write_optional_string'");
            let response_topic = sent_message.response_topic.as_ref().unwrap();
            assert!(!response_topic.contains('+'), "In the property update message for 'read_write_optional_string', the response_topic should not contain '+'");
            assert!(!response_topic.contains('#'), "In the property update message for 'read_write_optional_string', the response_topic should not contain '#'");

            assert!(sent_message.topic.contains(server_topic_param_map.get("prefix").unwrap()), "Expected the property update for 'read_write_optional_string' to contain the topic parameter 'prefix'");
        }

        {
            // Test setting the read_write_two_strings property if it is not read-only.
            // Create an example value to set the property to.
            ...
            mock_mqtt.clear_published_messages();
            let read_write_two_strings_handle = client.get_read_write_two_strings_handle();
            {
                // Guard scope
                let mut guard = read_write_two_strings_handle.write().await;
                *guard = read_write_two_strings_new_value;
            } // drop guard should send the mqtt request to update the property value on the server.
            sleep(Duration::from_millis(50)).await; // Its not so much the sleep time as the await that allows other async code to complete.

            let sent_message = mock_mqtt.last_published_message().expect(
                "Expected a property update message for 'read_write_two_strings' to be published",
            );
            assert!(sent_message.response_topic.is_some(), "Expected response_topic to be set on property update message for 'read_write_two_strings'");
            let response_topic = sent_message.response_topic.as_ref().unwrap();
            assert!(!response_topic.contains('+'), "In the property update message for 'read_write_two_strings', the response_topic should not contain '+'");
            assert!(!response_topic.contains('#'), "In the property update message for 'read_write_two_strings', the response_topic should not contain '#'");

            assert!(sent_message.topic.contains(server_topic_param_map.get("prefix").unwrap()), "Expected the property update for 'read_write_two_strings' to contain the topic parameter 'prefix'");
        }

        {
            // Test setting the read_write_struct property if it is not read-only.
            // Create an example value to set the property to.
            ...
            mock_mqtt.clear_published_messages();
            let read_write_struct_handle = client.get_read_write_struct_handle();
            {
                // Guard scope
                let mut guard = read_write_struct_handle.write().await;
                *guard = read_write_struct_new_value;
            } // drop guard should send the mqtt request to update the property value on the server.
            sleep(Duration::from_millis(50)).await; // Its not so much the sleep time as the await that allows other async code to complete.

            let sent_message = mock_mqtt.last_published_message().expect(
                "Expected a property update message for 'read_write_struct' to be published",
            );
            assert!(sent_message.response_topic.is_some(), "Expected response_topic to be set on property update message for 'read_write_struct'");
            let response_topic = sent_message.response_topic.as_ref().unwrap();
            assert!(!response_topic.contains('+'), "In the property update message for 'read_write_struct', the response_topic should not contain '+'");
            assert!(!response_topic.contains('#'), "In the property update message for 'read_write_struct', the response_topic should not contain '#'");

            assert!(sent_message.topic.contains(server_topic_param_map.get("prefix").unwrap()), "Expected the property update for 'read_write_struct' to contain the topic parameter 'prefix'");
        }

        {
            // Test setting the read_write_optional_struct property if it is not read-only.
            // Create an example value to set the property to.
            ...
            mock_mqtt.clear_published_messages();
            let read_write_optional_struct_handle = client.get_read_write_optional_struct_handle();
            {
                // Guard scope
                let mut guard = read_write_optional_struct_handle.write().await;
                *guard = read_write_optional_struct_new_value;
            } // drop guard should send the mqtt request to update the property value on the server.
            sleep(Duration::from_millis(50)).await; // Its not so much the sleep time as the await that allows other async code to complete.

            let sent_message = mock_mqtt.last_published_message().expect("Expected a property update message for 'read_write_optional_struct' to be published");
            assert!(sent_message.response_topic.is_some(), "Expected response_topic to be set on property update message for 'read_write_optional_struct'");
            let response_topic = sent_message.response_topic.as_ref().unwrap();
            assert!(!response_topic.contains('+'), "In the property update message for 'read_write_optional_struct', the response_topic should not contain '+'");
            assert!(!response_topic.contains('#'), "In the property update message for 'read_write_optional_struct', the response_topic should not contain '#'");

            assert!(sent_message.topic.contains(server_topic_param_map.get("prefix").unwrap()), "Expected the property update for 'read_write_optional_struct' to contain the topic parameter 'prefix'");
        }

        {
            // Test setting the read_write_two_structs property if it is not read-only.
            // Create an example value to set the property to.
            ...
            mock_mqtt.clear_published_messages();
            let read_write_two_structs_handle = client.get_read_write_two_structs_handle();
            {
                // Guard scope
                let mut guard = read_write_two_structs_handle.write().await;
                *guard = read_write_two_structs_new_value;
            } // drop guard should send the mqtt request to update the property value on the server.
            sleep(Duration::from_millis(50)).await; // Its not so much the sleep time as the await that allows other async code to complete.

            let sent_message = mock_mqtt.last_published_message().expect(
                "Expected a property update message for 'read_write_two_structs' to be published",
            );
            assert!(sent_message.response_topic.is_some(), "Expected response_topic to be set on property update message for 'read_write_two_structs'");
            let response_topic = sent_message.response_topic.as_ref().unwrap();
            assert!(!response_topic.contains('+'), "In the property update message for 'read_write_two_structs', the response_topic should not contain '+'");
            assert!(!response_topic.contains('#'), "In the property update message for 'read_write_two_structs', the response_topic should not contain '#'");

            assert!(sent_message.topic.contains(server_topic_param_map.get("prefix").unwrap()), "Expected the property update for 'read_write_two_structs' to contain the topic parameter 'prefix'");
        }

        {
            // Test setting the read_write_enum property if it is not read-only.
            // Create an example value to set the property to.
            let read_write_enum_new_value = Numbers::One;
            mock_mqtt.clear_published_messages();
            let read_write_enum_handle = client.get_read_write_enum_handle();
            {
                // Guard scope
                let mut guard = read_write_enum_handle.write().await;
                *guard = read_write_enum_new_value;
            } // drop guard should send the mqtt request to update the property value on the server.
            sleep(Duration::from_millis(50)).await; // Its not so much the sleep time as the await that allows other async code to complete.

            let sent_message = mock_mqtt
                .last_published_message()
                .expect("Expected a property update message for 'read_write_enum' to be published");
            assert!(sent_message.response_topic.is_some(), "Expected response_topic to be set on property update message for 'read_write_enum'");
            let response_topic = sent_message.response_topic.as_ref().unwrap();
            assert!(!response_topic.contains('+'), "In the property update message for 'read_write_enum', the response_topic should not contain '+'");
            assert!(!response_topic.contains('#'), "In the property update message for 'read_write_enum', the response_topic should not contain '#'");

            assert!(sent_message.topic.contains(server_topic_param_map.get("prefix").unwrap()), "Expected the property update for 'read_write_enum' to contain the topic parameter 'prefix'");
        }

        {
            // Test setting the read_write_optional_enum property if it is not read-only.
            // Create an example value to set the property to.
            let read_write_optional_enum_new_value = Some(Numbers::One);
            mock_mqtt.clear_published_messages();
            let read_write_optional_enum_handle = client.get_read_write_optional_enum_handle();
            {
                // Guard scope
                let mut guard = read_write_optional_enum_handle.write().await;
                *guard = read_write_optional_enum_new_value;
            } // drop guard should send the mqtt request to update the property value on the server.
            sleep(Duration::from_millis(50)).await; // Its not so much the sleep time as the await that allows other async code to complete.

            let sent_message = mock_mqtt.last_published_message().expect(
                "Expected a property update message for 'read_write_optional_enum' to be published",
            );
            assert!(sent_message.response_topic.is_some(), "Expected response_topic to be set on property update message for 'read_write_optional_enum'");
            let response_topic = sent_message.response_topic.as_ref().unwrap();
            assert!(!response_topic.contains('+'), "In the property update message for 'read_write_optional_enum', the response_topic should not contain '+'");
            assert!(!response_topic.contains('#'), "In the property update message for 'read_write_optional_enum', the response_topic should not contain '#'");

            assert!(sent_message.topic.contains(server_topic_param_map.get("prefix").unwrap()), "Expected the property update for 'read_write_optional_enum' to contain the topic parameter 'prefix'");
        }

        {
            // Test setting the read_write_two_enums property if it is not read-only.
            // Create an example value to set the property to.
            ...
            mock_mqtt.clear_published_messages();
            let read_write_two_enums_handle = client.get_read_write_two_enums_handle();
            {
                // Guard scope
                let mut guard = read_write_two_enums_handle.write().await;
                *guard = read_write_two_enums_new_value;
            } // drop guard should send the mqtt request to update the property value on the server.
            sleep(Duration::from_millis(50)).await; // Its not so much the sleep time as the await that allows other async code to complete.

            let sent_message = mock_mqtt.last_published_message().expect(
                "Expected a property update message for 'read_write_two_enums' to be published",
            );
            assert!(sent_message.response_topic.is_some(), "Expected response_topic to be set on property update message for 'read_write_two_enums'");
            let response_topic = sent_message.response_topic.as_ref().unwrap();
            assert!(!response_topic.contains('+'), "In the property update message for 'read_write_two_enums', the response_topic should not contain '+'");
            assert!(!response_topic.contains('#'), "In the property update message for 'read_write_two_enums', the response_topic should not contain '#'");

            assert!(sent_message.topic.contains(server_topic_param_map.get("prefix").unwrap()), "Expected the property update for 'read_write_two_enums' to contain the topic parameter 'prefix'");
        }

        {
            // Test setting the read_write_datetime property if it is not read-only.
            // Create an example value to set the property to.
            let read_write_datetime_new_value = chrono::Utc::now();
            mock_mqtt.clear_published_messages();
            let read_write_datetime_handle = client.get_read_write_datetime_handle();
            {
                // Guard scope
                let mut guard = read_write_datetime_handle.write().await;
                *guard = read_write_datetime_new_value;
            } // drop guard should send the mqtt request to update the property value on the server.
            sleep(Duration::from_millis(50)).await; // Its not so much the sleep time as the await that allows other async code to complete.

            let sent_message = mock_mqtt.last_published_message().expect(
                "Expected a property update message for 'read_write_datetime' to be published",
            );
            assert!(sent_message.response_topic.is_some(), "Expected response_topic to be set on property update message for 'read_write_datetime'");
            let response_topic = sent_message.response_topic.as_ref().unwrap();
            assert!(!response_topic.contains('+'), "In the property update message for 'read_write_datetime', the response_topic should not contain '+'");
            assert!(!response_topic.contains('#'), "In the property update message for 'read_write_datetime', the response_topic should not contain '#'");

            assert!(sent_message.topic.contains(server_topic_param_map.get("prefix").unwrap()), "Expected the property update for 'read_write_datetime' to contain the topic parameter 'prefix'");
        }

        {
            // Test setting the read_write_optional_datetime property if it is not read-only.
            // Create an example value to set the property to.
            let read_write_optional_datetime_new_value = Some(chrono::Utc::now());
            mock_mqtt.clear_published_messages();
            let read_write_optional_datetime_handle =
                client.get_read_write_optional_datetime_handle();
            {
                // Guard scope
                let mut guard = read_write_optional_datetime_handle.write().await;
                *guard = read_write_optional_datetime_new_value;
            } // drop guard should send the mqtt request to update the property value on the server.
            sleep(Duration::from_millis(50)).await; // Its not so much the sleep time as the await that allows other async code to complete.

            let sent_message = mock_mqtt.last_published_message().expect("Expected a property update message for 'read_write_optional_datetime' to be published");
            assert!(sent_message.response_topic.is_some(), "Expected response_topic to be set on property update message for 'read_write_optional_datetime'");
            let response_topic = sent_message.response_topic.as_ref().unwrap();
            assert!(!response_topic.contains('+'), "In the property update message for 'read_write_optional_datetime', the response_topic should not contain '+'");
            assert!(!response_topic.contains('#'), "In the property update message for 'read_write_optional_datetime', the response_topic should not contain '#'");

            assert!(sent_message.topic.contains(server_topic_param_map.get("prefix").unwrap()), "Expected the property update for 'read_write_optional_datetime' to contain the topic parameter 'prefix'");
        }

        {
            // Test setting the read_write_two_datetimes property if it is not read-only.
            // Create an example value to set the property to.
            ...
            mock_mqtt.clear_published_messages();
            let read_write_two_datetimes_handle = client.get_read_write_two_datetimes_handle();
            {
                // Guard scope
                let mut guard = read_write_two_datetimes_handle.write().await;
                *guard = read_write_two_datetimes_new_value;
            } // drop guard should send the mqtt request to update the property value on the server.
            sleep(Duration::from_millis(50)).await; // Its not so much the sleep time as the await that allows other async code to complete.

            let sent_message = mock_mqtt.last_published_message().expect(
                "Expected a property update message for 'read_write_two_datetimes' to be published",
            );
            assert!(sent_message.response_topic.is_some(), "Expected response_topic to be set on property update message for 'read_write_two_datetimes'");
            let response_topic = sent_message.response_topic.as_ref().unwrap();
            assert!(!response_topic.contains('+'), "In the property update message for 'read_write_two_datetimes', the response_topic should not contain '+'");
            assert!(!response_topic.contains('#'), "In the property update message for 'read_write_two_datetimes', the response_topic should not contain '#'");

            assert!(sent_message.topic.contains(server_topic_param_map.get("prefix").unwrap()), "Expected the property update for 'read_write_two_datetimes' to contain the topic parameter 'prefix'");
        }

        {
            // Test setting the read_write_duration property if it is not read-only.
            // Create an example value to set the property to.
            let read_write_duration_new_value = chrono::Duration::seconds(3536);
            mock_mqtt.clear_published_messages();
            let read_write_duration_handle = client.get_read_write_duration_handle();
            {
                // Guard scope
                let mut guard = read_write_duration_handle.write().await;
                *guard = read_write_duration_new_value;
            } // drop guard should send the mqtt request to update the property value on the server.
            sleep(Duration::from_millis(50)).await; // Its not so much the sleep time as the await that allows other async code to complete.

            let sent_message = mock_mqtt.last_published_message().expect(
                "Expected a property update message for 'read_write_duration' to be published",
            );
            assert!(sent_message.response_topic.is_some(), "Expected response_topic to be set on property update message for 'read_write_duration'");
            let response_topic = sent_message.response_topic.as_ref().unwrap();
            assert!(!response_topic.contains('+'), "In the property update message for 'read_write_duration', the response_topic should not contain '+'");
            assert!(!response_topic.contains('#'), "In the property update message for 'read_write_duration', the response_topic should not contain '#'");

            assert!(sent_message.topic.contains(server_topic_param_map.get("prefix").unwrap()), "Expected the property update for 'read_write_duration' to contain the topic parameter 'prefix'");
        }

        {
            // Test setting the read_write_optional_duration property if it is not read-only.
            // Create an example value to set the property to.
            let read_write_optional_duration_new_value = Some(chrono::Duration::seconds(3536));
            mock_mqtt.clear_published_messages();
            let read_write_optional_duration_handle =
                client.get_read_write_optional_duration_handle();
            {
                // Guard scope
                let mut guard = read_write_optional_duration_handle.write().await;
                *guard = read_write_optional_duration_new_value;
            } // drop guard should send the mqtt request to update the property value on the server.
            sleep(Duration::from_millis(50)).await; // Its not so much the sleep time as the await that allows other async code to complete.

            let sent_message = mock_mqtt.last_published_message().expect("Expected a property update message for 'read_write_optional_duration' to be published");
            assert!(sent_message.response_topic.is_some(), "Expected response_topic to be set on property update message for 'read_write_optional_duration'");
            let response_topic = sent_message.response_topic.as_ref().unwrap();
            assert!(!response_topic.contains('+'), "In the property update message for 'read_write_optional_duration', the response_topic should not contain '+'");
            assert!(!response_topic.contains('#'), "In the property update message for 'read_write_optional_duration', the response_topic should not contain '#'");

            assert!(sent_message.topic.contains(server_topic_param_map.get("prefix").unwrap()), "Expected the property update for 'read_write_optional_duration' to contain the topic parameter 'prefix'");
        }

        {
            // Test setting the read_write_two_durations property if it is not read-only.
            // Create an example value to set the property to.
            ...
            mock_mqtt.clear_published_messages();
            let read_write_two_durations_handle = client.get_read_write_two_durations_handle();
            {
                // Guard scope
                let mut guard = read_write_two_durations_handle.write().await;
                *guard = read_write_two_durations_new_value;
            } // drop guard should send the mqtt request to update the property value on the server.
            sleep(Duration::from_millis(50)).await; // Its not so much the sleep time as the await that allows other async code to complete.

            let sent_message = mock_mqtt.last_published_message().expect(
                "Expected a property update message for 'read_write_two_durations' to be published",
            );
            assert!(sent_message.response_topic.is_some(), "Expected response_topic to be set on property update message for 'read_write_two_durations'");
            let response_topic = sent_message.response_topic.as_ref().unwrap();
            assert!(!response_topic.contains('+'), "In the property update message for 'read_write_two_durations', the response_topic should not contain '+'");
            assert!(!response_topic.contains('#'), "In the property update message for 'read_write_two_durations', the response_topic should not contain '#'");

            assert!(sent_message.topic.contains(server_topic_param_map.get("prefix").unwrap()), "Expected the property update for 'read_write_two_durations' to contain the topic parameter 'prefix'");
        }

        {
            // Test setting the read_write_binary property if it is not read-only.
            // Create an example value to set the property to.
            let read_write_binary_new_value = vec![101, 120, 97, 109, 112, 108, 101];
            mock_mqtt.clear_published_messages();
            let read_write_binary_handle = client.get_read_write_binary_handle();
            {
                // Guard scope
                let mut guard = read_write_binary_handle.write().await;
                *guard = read_write_binary_new_value;
            } // drop guard should send the mqtt request to update the property value on the server.
            sleep(Duration::from_millis(50)).await; // Its not so much the sleep time as the await that allows other async code to complete.

            let sent_message = mock_mqtt.last_published_message().expect(
                "Expected a property update message for 'read_write_binary' to be published",
            );
            assert!(sent_message.response_topic.is_some(), "Expected response_topic to be set on property update message for 'read_write_binary'");
            let response_topic = sent_message.response_topic.as_ref().unwrap();
            assert!(!response_topic.contains('+'), "In the property update message for 'read_write_binary', the response_topic should not contain '+'");
            assert!(!response_topic.contains('#'), "In the property update message for 'read_write_binary', the response_topic should not contain '#'");

            assert!(sent_message.topic.contains(server_topic_param_map.get("prefix").unwrap()), "Expected the property update for 'read_write_binary' to contain the topic parameter 'prefix'");
        }

        {
            // Test setting the read_write_optional_binary property if it is not read-only.
            // Create an example value to set the property to.
            let read_write_optional_binary_new_value = Some(vec![101, 120, 97, 109, 112, 108, 101]);
            mock_mqtt.clear_published_messages();
            let read_write_optional_binary_handle = client.get_read_write_optional_binary_handle();
            {
                // Guard scope
                let mut guard = read_write_optional_binary_handle.write().await;
                *guard = read_write_optional_binary_new_value;
            } // drop guard should send the mqtt request to update the property value on the server.
            sleep(Duration::from_millis(50)).await; // Its not so much the sleep time as the await that allows other async code to complete.

            let sent_message = mock_mqtt.last_published_message().expect("Expected a property update message for 'read_write_optional_binary' to be published");
            assert!(sent_message.response_topic.is_some(), "Expected response_topic to be set on property update message for 'read_write_optional_binary'");
            let response_topic = sent_message.response_topic.as_ref().unwrap();
            assert!(!response_topic.contains('+'), "In the property update message for 'read_write_optional_binary', the response_topic should not contain '+'");
            assert!(!response_topic.contains('#'), "In the property update message for 'read_write_optional_binary', the response_topic should not contain '#'");

            assert!(sent_message.topic.contains(server_topic_param_map.get("prefix").unwrap()), "Expected the property update for 'read_write_optional_binary' to contain the topic parameter 'prefix'");
        }

        {
            // Test setting the read_write_two_binaries property if it is not read-only.
            // Create an example value to set the property to.
            ...
            mock_mqtt.clear_published_messages();
            let read_write_two_binaries_handle = client.get_read_write_two_binaries_handle();
            {
                // Guard scope
                let mut guard = read_write_two_binaries_handle.write().await;
                *guard = read_write_two_binaries_new_value;
            } // drop guard should send the mqtt request to update the property value on the server.
            sleep(Duration::from_millis(50)).await; // Its not so much the sleep time as the await that allows other async code to complete.

            let sent_message = mock_mqtt.last_published_message().expect(
                "Expected a property update message for 'read_write_two_binaries' to be published",
            );
            assert!(sent_message.response_topic.is_some(), "Expected response_topic to be set on property update message for 'read_write_two_binaries'");
            let response_topic = sent_message.response_topic.as_ref().unwrap();
            assert!(!response_topic.contains('+'), "In the property update message for 'read_write_two_binaries', the response_topic should not contain '+'");
            assert!(!response_topic.contains('#'), "In the property update message for 'read_write_two_binaries', the response_topic should not contain '#'");

            assert!(sent_message.topic.contains(server_topic_param_map.get("prefix").unwrap()), "Expected the property update for 'read_write_two_binaries' to contain the topic parameter 'prefix'");
        }

        {
            // Test setting the read_write_list_of_strings property if it is not read-only.
            // Create an example value to set the property to.
            let read_write_list_of_strings_new_value =
                vec!["apples".to_string(), "foo".to_string()];
            mock_mqtt.clear_published_messages();
            let read_write_list_of_strings_handle = client.get_read_write_list_of_strings_handle();
            {
                // Guard scope
                let mut guard = read_write_list_of_strings_handle.write().await;
                *guard = read_write_list_of_strings_new_value;
            } // drop guard should send the mqtt request to update the property value on the server.
            sleep(Duration::from_millis(50)).await; // Its not so much the sleep time as the await that allows other async code to complete.

            let sent_message = mock_mqtt.last_published_message().expect("Expected a property update message for 'read_write_list_of_strings' to be published");
            assert!(sent_message.response_topic.is_some(), "Expected response_topic to be set on property update message for 'read_write_list_of_strings'");
            let response_topic = sent_message.response_topic.as_ref().unwrap();
            assert!(!response_topic.contains('+'), "In the property update message for 'read_write_list_of_strings', the response_topic should not contain '+'");
            assert!(!response_topic.contains('#'), "In the property update message for 'read_write_list_of_strings', the response_topic should not contain '#'");

            assert!(sent_message.topic.contains(server_topic_param_map.get("prefix").unwrap()), "Expected the property update for 'read_write_list_of_strings' to contain the topic parameter 'prefix'");
        }

        {
            // Test setting the read_write_lists property if it is not read-only.
            // Create an example value to set the property to.
            ...
            mock_mqtt.clear_published_messages();
            let read_write_lists_handle = client.get_read_write_lists_handle();
            {
                // Guard scope
                let mut guard = read_write_lists_handle.write().await;
                *guard = read_write_lists_new_value;
            } // drop guard should send the mqtt request to update the property value on the server.
            sleep(Duration::from_millis(50)).await; // Its not so much the sleep time as the await that allows other async code to complete.

            let sent_message = mock_mqtt.last_published_message().expect(
                "Expected a property update message for 'read_write_lists' to be published",
            );
            assert!(sent_message.response_topic.is_some(), "Expected response_topic to be set on property update message for 'read_write_lists'");
            let response_topic = sent_message.response_topic.as_ref().unwrap();
            assert!(!response_topic.contains('+'), "In the property update message for 'read_write_lists', the response_topic should not contain '+'");
            assert!(!response_topic.contains('#'), "In the property update message for 'read_write_lists', the response_topic should not contain '#'");

            assert!(sent_message.topic.contains(server_topic_param_map.get("prefix").unwrap()), "Expected the property update for 'read_write_lists' to contain the topic parameter 'prefix'");
        }
    }
}
