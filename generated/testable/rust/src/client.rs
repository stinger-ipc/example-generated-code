...
/*
DO NOT MODIFY THIS FILE.  It is automatically generated by Stinger-IPC 0.8.7b0 and changes will be over-written
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_integer_prop.recv().await
                    {
                        ...
                        if let Some(responder) = opt_responder {
                            ...
                            error!("No responder provided for property update request for 'read_write_integer'");
                        }
                    }
                });
            }
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_only_integer_prop.recv().await
                    {
                        ...
                        if let Some(responder) = opt_responder {
                            ...
                            error!("No responder provided for property update request for 'read_only_integer'");
                        }
                    }
                });
            }
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_optional_integer_prop.recv().await
                    {
                        ...
                        if let Some(responder) = opt_responder {
                            ...
                            error!("No responder provided for property update request for 'read_write_optional_integer'");
                        }
                    }
                });
            }
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_two_integers_prop.recv().await
                    {
                        ...
                        if let Some(responder) = opt_responder {
                            ...
                            error!("No responder provided for property update request for 'read_write_two_integers'");
                        }
                    }
                });
            }
                ...
                props.read_only_string.take_request_receiver()
            {
                tokio::spawn(async move {
                        ...
                        rx_for_read_only_string_prop.recv().await
                    {
                        ...
                        .unwrap();
                        if let Some(responder) = opt_responder {
                            let resp_topic = strfmt("client/{client_id}/testable/property/read_only_string/update/response", &topic_param_map).unwrap();
                            let correlation_id = Uuid::new_v4();
                            let (sender, receiver) = oneshot::channel();
                            {
                            ...
                            error!("No responder provided for property update request for 'read_only_string'");
                        }
                    }
                });
            }
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_string_prop.recv().await
                    {
                        ...
                        if let Some(responder) = opt_responder {
                            ...
                            error!("No responder provided for property update request for 'read_write_string'");
                        }
                    }
                });
            }
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_optional_string_prop.recv().await
                    {
                        ...
                        if let Some(responder) = opt_responder {
                            ...
                            error!("No responder provided for property update request for 'read_write_optional_string'");
                        }
                    }
                });
            }
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_two_strings_prop.recv().await
                    {
                        ...
                        if let Some(responder) = opt_responder {
                            ...
                            error!("No responder provided for property update request for 'read_write_two_strings'");
                        }
                    }
                });
            }
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_struct_prop.recv().await
                    {
                        ...
                        if let Some(responder) = opt_responder {
                            ...
                            error!("No responder provided for property update request for 'read_write_struct'");
                        }
                    }
                });
            }
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_optional_struct_prop.recv().await
                    {
                        ...
                        if let Some(responder) = opt_responder {
                            ...
                            error!("No responder provided for property update request for 'read_write_optional_struct'");
                        }
                    }
                });
            }
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_two_structs_prop.recv().await
                    {
                        ...
                        if let Some(responder) = opt_responder {
                            ...
                            error!("No responder provided for property update request for 'read_write_two_structs'");
                        }
                    }
                });
            }
                ...
                props.read_only_enum.take_request_receiver()
            {
                tokio::spawn(async move {
                    while let Some((value, opt_responder)) = rx_for_read_only_enum_prop.recv().await
                    {
                        ...
                        .unwrap();
                        if let Some(responder) = opt_responder {
                            let resp_topic = strfmt("client/{client_id}/testable/property/read_only_enum/update/response", &topic_param_map).unwrap();
                            let correlation_id = Uuid::new_v4();
                            let (sender, receiver) = oneshot::channel();
                            {
                            ...
                            error!("No responder provided for property update request for 'read_only_enum'");
                        }
                    }
                });
            }
                ...
                props.read_write_enum.take_request_receiver()
            {
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_enum_prop.recv().await
                    {
                        ...
                        .unwrap();
                        if let Some(responder) = opt_responder {
                            let resp_topic = strfmt("client/{client_id}/testable/property/read_write_enum/update/response", &topic_param_map).unwrap();
                            let correlation_id = Uuid::new_v4();
                            let (sender, receiver) = oneshot::channel();
                            {
                            ...
                            error!("No responder provided for property update request for 'read_write_enum'");
                        }
                    }
                });
            }
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_optional_enum_prop.recv().await
                    {
                        ...
                        if let Some(responder) = opt_responder {
                            ...
                            error!("No responder provided for property update request for 'read_write_optional_enum'");
                        }
                    }
                });
            }
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_two_enums_prop.recv().await
                    {
                        ...
                        if let Some(responder) = opt_responder {
                            ...
                            error!("No responder provided for property update request for 'read_write_two_enums'");
                        }
                    }
                });
            }
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_datetime_prop.recv().await
                    {
                        ...
                        if let Some(responder) = opt_responder {
                            ...
                            error!("No responder provided for property update request for 'read_write_datetime'");
                        }
                    }
                });
            }
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_optional_datetime_prop.recv().await
                    {
                        ...
                        if let Some(responder) = opt_responder {
                            ...
                            error!("No responder provided for property update request for 'read_write_optional_datetime'");
                        }
                    }
                });
            }
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_two_datetimes_prop.recv().await
                    {
                        ...
                        if let Some(responder) = opt_responder {
                            ...
                            error!("No responder provided for property update request for 'read_write_two_datetimes'");
                        }
                    }
                });
            }
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_duration_prop.recv().await
                    {
                        ...
                        if let Some(responder) = opt_responder {
                            ...
                            error!("No responder provided for property update request for 'read_write_duration'");
                        }
                    }
                });
            }
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_optional_duration_prop.recv().await
                    {
                        ...
                        if let Some(responder) = opt_responder {
                            ...
                            error!("No responder provided for property update request for 'read_write_optional_duration'");
                        }
                    }
                });
            }
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_two_durations_prop.recv().await
                    {
                        ...
                        if let Some(responder) = opt_responder {
                            ...
                            error!("No responder provided for property update request for 'read_write_two_durations'");
                        }
                    }
                });
            }
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_binary_prop.recv().await
                    {
                        ...
                        if let Some(responder) = opt_responder {
                            ...
                            error!("No responder provided for property update request for 'read_write_binary'");
                        }
                    }
                });
            }
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_optional_binary_prop.recv().await
                    {
                        ...
                        if let Some(responder) = opt_responder {
                            ...
                            error!("No responder provided for property update request for 'read_write_optional_binary'");
                        }
                    }
                });
            }
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_two_binaries_prop.recv().await
                    {
                        ...
                        if let Some(responder) = opt_responder {
                            ...
                            error!("No responder provided for property update request for 'read_write_two_binaries'");
                        }
                    }
                });
            }
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_list_of_strings_prop.recv().await
                    {
                        ...
                        if let Some(responder) = opt_responder {
                            ...
                            error!("No responder provided for property update request for 'read_write_list_of_strings'");
                        }
                    }
                });
            }
                ...
                props.read_write_lists.take_request_receiver()
            {
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_lists_prop.recv().await
                    {
                        ...
                        .unwrap();
                        if let Some(responder) = opt_responder {
                            let resp_topic = strfmt("client/{client_id}/testable/property/read_write_lists/update/response", &topic_param_map).unwrap();
                            let correlation_id = Uuid::new_v4();
                            let (sender, receiver) = oneshot::channel();
                            {
                            ...
                            error!("No responder provided for property update request for 'read_write_lists'");
                        }
                    }
                });
            }
