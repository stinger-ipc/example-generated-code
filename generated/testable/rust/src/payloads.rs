...
use crate::serde_formats::base64_binary_format;
...
#[allow(dead_code)]
impl CallWithNothingRequestObject {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallWithNothingReturnValues {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOneIntegerRequestObject {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOneIntegerReturnValues {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOptionalIntegerRequestObject {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOptionalIntegerReturnValues {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallThreeIntegersRequestObject {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallThreeIntegersReturnValues {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOneStringRequestObject {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOneStringReturnValues {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOptionalStringRequestObject {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOptionalStringReturnValues {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallThreeStringsRequestObject {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallThreeStringsReturnValues {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOptionalEnumRequestObject {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOptionalEnumReturnValues {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallThreeEnumsRequestObject {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallThreeEnumsReturnValues {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOneStructRequestObject {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOneStructReturnValues {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOptionalStructRequestObject {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOptionalStructReturnValues {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallThreeStructsRequestObject {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallThreeStructsReturnValues {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOneDateTimeRequestObject {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOneDateTimeReturnValues {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOptionalDateTimeRequestObject {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOptionalDateTimeReturnValues {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallThreeDateTimesRequestObject {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallThreeDateTimesReturnValues {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOneDurationRequestObject {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOneDurationReturnValues {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOptionalDurationRequestObject {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOptionalDurationReturnValues {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallThreeDurationsRequestObject {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallThreeDurationsReturnValues {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOneBinaryRequestObject {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOneBinaryReturnValues {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOptionalBinaryRequestObject {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOptionalBinaryReturnValues {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallThreeBinariesRequestObject {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallThreeBinariesReturnValues {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOneListOfIntegersRequestObject {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOneListOfIntegersReturnValues {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOptionalListOfFloatsRequestObject {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallOptionalListOfFloatsReturnValues {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl CallTwoListsRequestObject {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
// Structures for `jsonSchemaValidatedInt` signal
#[allow(dead_code, non_snake_case)]
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct JsonSchemaValidatedIntSignalPayload {
    /// The integer value.
    pub value: i32,
}
#[allow(dead_code)]
impl JsonSchemaValidatedIntSignalPayload {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
    ...
    pub fn validate_schema(&self) -> Result<(), String> {
        {
            let schema: serde_json::Value =
                serde_json::from_str(r##"{"maximum": 100, "minimum": 0}"##)
                    .map_err(|e| format!("embedded schema for field 'value' is invalid: {}", e))?;
            let instance = serde_json::to_value(&self.value)
                .map_err(|e| format!("could not serialize field 'value': {}", e))?;
            let validator = jsonschema::validator_for(&schema)
                .map_err(|e| format!("could not build validator for field 'value': {}", e))?;
            validator
                .validate(&instance)
                .map_err(|e| format!("field 'value' failed schema validation: {}", e))?;
        }
        Ok(())
    }
}
...
#[allow(dead_code)]
impl SingleOptionalIntSignalPayload {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl ThreeIntegersSignalPayload {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl SingleStringSignalPayload {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
// Structures for `jsonSchemaValidatedString` signal
#[allow(dead_code, non_snake_case)]
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct JsonSchemaValidatedStringSignalPayload {
    /// The string value.
    pub value: String,
}
#[allow(dead_code)]
impl JsonSchemaValidatedStringSignalPayload {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
    ...
    pub fn validate_schema(&self) -> Result<(), String> {
        {
            let schema: serde_json::Value =
                serde_json::from_str(r##"{"maxLength": 10, "minLength": 1}"##)
                    .map_err(|e| format!("embedded schema for field 'value' is invalid: {}", e))?;
            let instance = serde_json::to_value(&self.value)
                .map_err(|e| format!("could not serialize field 'value': {}", e))?;
            let validator = jsonschema::validator_for(&schema)
...
#[allow(dead_code)]
impl SingleOptionalStringSignalPayload {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl ThreeStringsSignalPayload {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl SingleOptionalEnumSignalPayload {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl SingleStructSignalPayload {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl SingleOptionalStructSignalPayload {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl ThreeStructsSignalPayload {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl SingleDateTimeSignalPayload {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl SingleOptionalDatetimeSignalPayload {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl ThreeDateTimesSignalPayload {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl SingleDurationSignalPayload {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl SingleOptionalDurationSignalPayload {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl ThreeDurationsSignalPayload {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl SingleBinarySignalPayload {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl SingleOptionalBinarySignalPayload {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl ThreeBinariesSignalPayload {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl SingleArrayOfIntegersSignalPayload {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl SingleOptionalArrayOfStringsSignalPayload {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl ArrayOfEveryTypeSignalPayload {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl ReadWriteOptionalIntegerProperty {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl ReadWriteTwoIntegersProperty {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl ReadWriteOptionalStringProperty {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl ReadWriteTwoStringsProperty {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl ReadWriteOptionalStructProperty {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl ReadWriteTwoStructsProperty {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl ReadWriteOptionalEnumProperty {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl ReadWriteTwoEnumsProperty {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl ReadWriteDatetimeProperty {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl ReadWriteOptionalDatetimeProperty {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl ReadWriteTwoDatetimesProperty {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl ReadWriteDurationProperty {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl ReadWriteOptionalDurationProperty {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl ReadWriteTwoDurationsProperty {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl ReadWriteOptionalBinaryProperty {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl ReadWriteTwoBinariesProperty {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
#[allow(dead_code)]
impl ReadWriteListOfStringsProperty {
    /// Validate fields that declare a JSON schema constraint.
    ///
    /// Returns `Ok(())` if all schema-constrained fields conform to their schema,
    /// or if no field declares a schema.  Returns `Err` with a description if a
...
mod tests {
    ...
    fn test_read_write_struct_property_json_format() {
        ...
        let json_str = r#"{
            "value": {"the_bool": true, "the_int": 42, "the_number": 3.14, "the_str": "apples", "the_enum": 1, "an_entry_object": {"drink": true, "sandwich": "apples", "crackers": 3.14, "order_number": 42, "time_of_lunch": "1990-07-08T16:20:00Z", "duration_of_lunch": "PT3536S"}, "date_and_time": "1990-07-08T16:20:00Z", "time_duration": "PT3536S", "data": "ZXhhbXBsZSBiaW5hcnkgZGF0YQ==", "OptionalInteger": 42, "OptionalString": "apples", "OptionalEnum": 1, "optionalEntryObject": {"key": 42, "value": "apples"}, "OptionalDateTime": "1990-07-08T16:20:00Z", "OptionalDuration": null, "OptionalBinary": "ZXhhbXBsZSBiaW5hcnkgZGF0YQ==", "array_of_integers": [42, 2022], "optional_array_of_integers": [42, 2022], "array_of_strings": ["apples", "foo"], "optional_array_of_strings": null, "array_of_enums": [], "optional_array_of_enums": null, "array_of_datetimes": [], "optional_array_of_datetimes": [], "array_of_durations": [], "optional_array_of_durations": ["PT3536S", "PT975S"], "array_of_binaries": ["ZXhhbXBsZSBiaW5hcnkgZGF0YQ==", "ZXhhbXBsZSBiaW5hcnkgZGF0YQ=="], "optional_array_of_binaries": ["ZXhhbXBsZSBiaW5hcnkgZGF0YQ==", "ZXhhbXBsZSBiaW5hcnkgZGF0YQ=="], "array_of_entry_objects": [{"key": 42, "value": "apples"}, {"key": 2022, "value": "foo"}], "optional_array_of_entry_objects": [{"key": 42, "value": "apples"}, {"key": 2022, "value": "foo"}]} 
        }"#;
    ...
    fn test_read_write_optional_struct_property_json_format() {
        // Test deserializing from a known JSON string of STRUCT.
        let json_str = r#"{
            "value": {"the_bool": true, "the_int": 42, "the_number": 3.14, "the_str": "apples", "the_enum": 1, "an_entry_object": {"drink": true, "sandwich": "apples", "crackers": 3.14, "order_number": 42, "time_of_lunch": "1990-07-08T16:20:00Z", "duration_of_lunch": "PT3536S"}, "date_and_time": "1990-07-08T16:20:00Z", "time_duration": "PT3536S", "data": "ZXhhbXBsZSBiaW5hcnkgZGF0YQ==", "OptionalInteger": 42, "OptionalString": "apples", "OptionalEnum": 1, "optionalEntryObject": {"key": 42, "value": "apples"}, "OptionalDateTime": "1990-07-08T16:20:00Z", "OptionalDuration": null, "OptionalBinary": "ZXhhbXBsZSBiaW5hcnkgZGF0YQ==", "array_of_integers": [42, 2022], "optional_array_of_integers": null, "array_of_strings": ["apples", "foo"], "optional_array_of_strings": [], "array_of_enums": [1, 1], "optional_array_of_enums": null, "array_of_datetimes": [], "optional_array_of_datetimes": ["1990-07-08T16:20:00Z", "1990-07-08T16:20:00Z"], "array_of_durations": ["PT3536S", "PT975S"], "optional_array_of_durations": ["PT3536S", "PT975S"], "array_of_binaries": [], "optional_array_of_binaries": [], "array_of_entry_objects": [], "optional_array_of_entry_objects": []} 
        }"#;
    ...
    fn test_read_write_two_structs_property_json_format() {
        ...
        let json_str = r#"{
            ...
            "second": {"the_bool": true, "the_int": 42, "the_number": 3.14, "the_str": "apples", "the_enum": 1, "an_entry_object": {"drink": true, "sandwich": "apples", "crackers": 3.14, "order_number": 42, "time_of_lunch": "1990-07-08T16:20:00Z", "duration_of_lunch": "PT3536S"}, "date_and_time": "1990-07-08T16:20:00Z", "time_duration": "PT3536S", "data": "ZXhhbXBsZSBiaW5hcnkgZGF0YQ==", "OptionalInteger": 42, "OptionalString": "apples", "OptionalEnum": 1, "optionalEntryObject": {"key": 42, "value": "apples"}, "OptionalDateTime": "1990-07-08T16:20:00Z", "OptionalDuration": null, "OptionalBinary": "ZXhhbXBsZSBiaW5hcnkgZGF0YQ==", "array_of_integers": [42, 2022], "optional_array_of_integers": [42, 2022], "array_of_strings": [], "optional_array_of_strings": ["apples", "foo"], "array_of_enums": [1, 1], "optional_array_of_enums": [1, 1], "array_of_datetimes": [], "optional_array_of_datetimes": [], "array_of_durations": ["PT3536S", "PT975S"], "optional_array_of_durations": [], "array_of_binaries": ["ZXhhbXBsZSBiaW5hcnkgZGF0YQ==", "ZXhhbXBsZSBiaW5hcnkgZGF0YQ=="], "optional_array_of_binaries": ["ZXhhbXBsZSBiaW5hcnkgZGF0YQ==", "ZXhhbXBsZSBiaW5hcnkgZGF0YQ=="], "array_of_entry_objects": [{"key": 42, "value": "apples"}, {"key": 2022, "value": "foo"}], "optional_array_of_entry_objects": null} 
        }"#;
    ...
    fn test_read_write_duration_property_json_format() {
        // Test deserializing from a known JSON string of DURATION.
        let json_str = r#"{
            "value": "PT3536S" 
        }"#;
    ...
    fn test_read_write_binary_property_json_format() {
        // Test deserializing from a known JSON string of BINARY.
        let json_str = r#"{
    ...
    fn test_read_write_list_of_strings_property_json_format() {
        // Test deserializing from a known JSON string of ARRAY.
        let json_str = r#"{
            "value": ["apples", "foo"] 
        }"#;
