...
class FullClient:
    ...
    def unmatched_signal_handler(self, handler: UnmatchedSignalCallbackType):
        ...
        if self._all_signals_subscription_id == UNINITIALIZED_SUBSCRIPTION_ID:
            self._all_signals_subscription_id = self._conn.subscribe("{prefix}/Full/{service_id}/signal/+".format(**self._topic_template_kwargs), self._receive_unmatched_signal_message)  # type: ignore[str-format]
        return handler
