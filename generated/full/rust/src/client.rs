...
impl<C: Mqtt5PubSub + Clone + Send + 'static> FullClient<C> {
    ...
    pub async fn run_loop(&mut self) -> Result<(), JoinError> {
        ...
        let props = self.properties.clone();
        {
            ...
            let prefix_for_favorite_number_prop = self.topic_param_prefix.clone();
                ...
                props.favorite_number.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property favorite_number has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_favorite_number_prop.clone(),
                            ),
                        ]);
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'favorite_number' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_favorite_number_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!(
                                    "Received property update response for 'favorite_number': {:?}",
                                    result
                                );
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            ...
                                            info!("No responder provided for property update request for 'favorite_number'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_favorite_foods_prop = self.topic_param_prefix.clone();
                ...
                props.favorite_foods.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property favorite_foods has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            ("prefix".to_string(), prefix_for_favorite_foods_prop.clone()),
                        ]);
                        let topic: String = strfmt(
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'favorite_foods' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_favorite_foods_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!(
                                    "Received property update response for 'favorite_foods': {:?}",
                                    result
                                );
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            ...
                                            info!("No responder provided for property update request for 'favorite_foods'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_lunch_menu_prop = self.topic_param_prefix.clone();
            ...
            if let Some(mut rx_for_lunch_menu_prop) = props.lunch_menu.take_request_receiver() {
                tokio::spawn(async move {
                    while let Some((value, opt_responder)) = rx_for_lunch_menu_prop.recv().await {
                        debug!("Property lunch_menu has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "client_id".to_string(),
                                client_id_for_lunch_menu_prop.clone(),
                            ),
                            ("prefix".to_string(), prefix_for_lunch_menu_prop.clone()),
                        ]);
                        let topic: String = strfmt(
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'lunch_menu' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_lunch_menu_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!(
                                    "Received property update response for 'lunch_menu': {:?}",
                                    result
                                );
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            ...
                                            info!("No responder provided for property update request for 'lunch_menu'");
                                        }
                                    }
                                    _ => {
                                        warn!(
                                            "Property update request for 'lunch_menu' failed: {:?}",
                                            result
                                        );
                                        if let Some(responder) = opt_responder {
                                            let _ = responder.send(None);
...

        {
            ...
            let prefix_for_family_name_prop = self.topic_param_prefix.clone();
            ...
            if let Some(mut rx_for_family_name_prop) = props.family_name.take_request_receiver() {
                tokio::spawn(async move {
                    while let Some((value, opt_responder)) = rx_for_family_name_prop.recv().await {
                        debug!("Property family_name has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "client_id".to_string(),
                                client_id_for_family_name_prop.clone(),
                            ),
                            ("prefix".to_string(), prefix_for_family_name_prop.clone()),
                        ]);
                        let topic: String = strfmt(
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'family_name' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_family_name_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!(
                                    "Received property update response for 'family_name': {:?}",
                                    result
                                );
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            ...
                                            info!("No responder provided for property update request for 'family_name'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_last_breakfast_time_prop = self.topic_param_prefix.clone();
                ...
                props.last_breakfast_time.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property last_breakfast_time has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_last_breakfast_time_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'last_breakfast_time' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_last_breakfast_time_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!("Received property update response for 'last_breakfast_time': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'last_breakfast_time'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_last_birthdays_prop = self.topic_param_prefix.clone();
                ...
                props.last_birthdays.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property last_birthdays has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            ("prefix".to_string(), prefix_for_last_birthdays_prop.clone()),
                        ]);
                        let topic: String = strfmt(
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'last_birthdays' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_last_birthdays_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!(
                                    "Received property update response for 'last_birthdays': {:?}",
                                    result
                                );
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            ...
                                            info!("No responder provided for property update request for 'last_birthdays'");
                                        }
                                    }
                                    _ => {
