...
impl<C: Mqtt5PubSub + Clone + Send + 'static> WeatherClient<C> {
    ...
    pub async fn run_loop(&mut self) -> Result<(), JoinError> {
        ...
        let props = self.properties.clone();
        {
            ...
            let prefix_for_location_prop = self.topic_param_prefix.clone();
            ...
            if let Some(mut rx_for_location_prop) = props.location.take_request_receiver() {
                tokio::spawn(async move {
                    while let Some((value, opt_responder)) = rx_for_location_prop.recv().await {
                        debug!("Property location has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            ("client_id".to_string(), client_id_for_location_prop.clone()),
                            ("prefix".to_string(), prefix_for_location_prop.clone()),
                        ]);
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'location' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_location_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!(
                                    "Received property update response for 'location': {:?}",
                                    result
                                );
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            ...
                                            info!("No responder provided for property update request for 'location'");
                                        }
                                    }
                                    _ => {
                                        warn!(
                                            "Property update request for 'location' failed: {:?}",
                                            result
                                        );
                                        if let Some(responder) = opt_responder {
                                            let _ = responder.send(None);
                            ...
                            Err(e) => {
                                warn!(
                                    "Failed to create property update message for 'location': {:?}",
                                    e
                                );
                                if let Some(responder) = opt_responder {
                                    let _ = responder.send(None);
...

        {
            ...
            let prefix_for_current_temperature_prop = self.topic_param_prefix.clone();
                ...
                props.current_temperature.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property current_temperature has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_current_temperature_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                        ...
                        let resp_topic = strfmt("client/{client_id}/weather/property/current_temperature/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'current_temperature' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_current_temperature_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!("Received property update response for 'current_temperature': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'current_temperature'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_current_condition_prop = self.topic_param_prefix.clone();
                ...
                props.current_condition.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property current_condition has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_current_condition_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'current_condition' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_current_condition_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!("Received property update response for 'current_condition': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'current_condition'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_daily_forecast_prop = self.topic_param_prefix.clone();
                ...
                props.daily_forecast.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property daily_forecast has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            ("prefix".to_string(), prefix_for_daily_forecast_prop.clone()),
                        ]);
                        let topic: String = strfmt(
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'daily_forecast' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_daily_forecast_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!(
                                    "Received property update response for 'daily_forecast': {:?}",
                                    result
                                );
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            ...
                                            info!("No responder provided for property update request for 'daily_forecast'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_hourly_forecast_prop = self.topic_param_prefix.clone();
                ...
                props.hourly_forecast.take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property hourly_forecast has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_hourly_forecast_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'hourly_forecast' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_hourly_forecast_prop.publish(msg).await;
                                let result = receiver.await;
                                debug!(
                                    "Received property update response for 'hourly_forecast': {:?}",
                                    result
                                );
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            ...
                                            info!("No responder provided for property update request for 'hourly_forecast'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_current_condition_refresh_interval_prop =
                self.topic_param_prefix.clone();
                ...
                .take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property current_condition_refresh_interval has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_current_condition_refresh_interval_prop.clone(),
                            ),
                        ]);
                        ...
                        let resp_topic = strfmt("client/{client_id}/weather/property/current_condition_refresh_interval/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                            let mut hashmap = resp_map_for_current_condition_refresh_interval_prop
                                .lock()
                                .expect("Mutex was poisoned");
                            hashmap.insert(correlation_id.clone(), sender);
                        }
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'current_condition_refresh_interval' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_current_condition_refresh_interval_prop
                                        .publish(msg)
                                        .await;
                                let result = receiver.await;
                                debug!("Received property update response for 'current_condition_refresh_interval': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'current_condition_refresh_interval'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_hourly_forecast_refresh_interval_prop = self.topic_param_prefix.clone();
                ...
                .take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property hourly_forecast_refresh_interval has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_hourly_forecast_refresh_interval_prop.clone(),
                            ),
                        ]);
                        ...
                        let resp_topic = strfmt("client/{client_id}/weather/property/hourly_forecast_refresh_interval/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                            let mut hashmap = resp_map_for_hourly_forecast_refresh_interval_prop
                                .lock()
                                .expect("Mutex was poisoned");
                            hashmap.insert(correlation_id.clone(), sender);
                        }
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'hourly_forecast_refresh_interval' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_hourly_forecast_refresh_interval_prop
                                        .publish(msg)
                                        .await;
                                let result = receiver.await;
                                debug!("Received property update response for 'hourly_forecast_refresh_interval': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'hourly_forecast_refresh_interval'");
                                        }
                                    }
                                    _ => {
...

        {
            ...
            let prefix_for_daily_forecast_refresh_interval_prop = self.topic_param_prefix.clone();
                ...
                .take_request_receiver()
            {
                tokio::spawn(async move {
                    ...
                    {
                        debug!("Property daily_forecast_refresh_interval has changed locally to {:?}, sending update request to server", value);
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "prefix".to_string(),
                                prefix_for_daily_forecast_refresh_interval_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt("{prefix}/weather/{service_id}/property/daily_forecast_refresh_interval/update", &topic_param_map).unwrap();

                        let resp_topic = strfmt("client/{client_id}/weather/property/daily_forecast_refresh_interval/update/response", &topic_param_map).unwrap();
                        let correlation_id = Uuid::new_v4();
                        let (sender, receiver) = oneshot::channel();
                        {
                        ...
                        match message::property_update_request(
                            ...
                            Ok(msg) => {
                                debug!("Publishing property update request for 'daily_forecast_refresh_interval' to topic '{}': {:?}", topic, payload_obj);
                                let _publish_result =
                                    publisher_for_daily_forecast_refresh_interval_prop
                                        .publish(msg)
                                        .await;
                                let result = receiver.await;
                                debug!("Received property update response for 'daily_forecast_refresh_interval': {:?}", result);
                                match result {
                                    Ok(MethodReturnCode::Success(opt_response_text)) => {
                                        if let Some(responder) = opt_responder {
                                            if let Some(response_text) = opt_response_text {
                                            ...
                                            info!("No responder provided for property update request for 'daily_forecast_refresh_interval'");
                                        }
                                    }
                                    _ => {
